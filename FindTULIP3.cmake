...
# TULIP_PLUGIN_VERSION- The version of Tulip
#
...
file(STRINGS ${TULIP_INCLUDE_DIR}/tulip/TulipRelease.h TEMPVAR REGEX "[0-9]*\\.[0-9]*" NO_HEX_CONVERSION)
string( REGEX MATCH "[0-9]*\\.[0-9]*\\.[0-9]*" TULIP_VERSION ${TEMPVAR} )
ENDIF(NOT TULIP_VERSION AND TULIP_INCLUDE_DIR)

IF(NOT TULIP_PLUGIN_VERSION AND TULIP_VERSION)
string( REGEX MATCH "[0-9]*\\.[0-9]*" TULIP_PLUGIN_VERSION ${TULIP_VERSION} )
ENDIF(NOT TULIP_PLUGIN_VERSION AND TULIP_VERSION)

IF(NOT TULIP_PLUGINS_PATH AND TULIP_INCLUDE_DIR)
set(TULIP_PLUGINS_PATH ${TULIP_INCLUDE_DIR}/../lib/tlp)
ENDIF(NOT TULIP_PLUGINS_PATH AND TULIP_INCLUDE_DIR)

FIND_LIBRARY(TULIP_LIBRARY "tulip-${TULIP_PLUGIN_VERSION}"
  PATHS ${TULIP_PATHS}
  )

FIND_LIBRARY(TULIP_QT4_LIBRARY "tulip-qt4-${TULIP_PLUGIN_VERSION}"
  PATHS ${TULIP_PATHS}
  )

FIND_LIBRARY(TULIP_OGL_LIBRARY "tulip-ogl-${TULIP_PLUGIN_VERSION}"
  PATHS ${TULIP_PATHS}
  )

FIND_LIBRARY(TULIP_PLUGINS_MANAGER_LIBRARY "tulip-pluginsmanager-${TULIP_PLUGIN_VERSION}"
  PATHS ${TULIP_PATHS}
  )
