...
int main(int argc,char **argv) {
...
#ifdef _MSC_VER
  // Add path to Tulip pdb files generated by Visual Studio (for configurations Debug and RelWithDebInfo)
  ...
  Perspective *perspective = PluginLister::instance()->getPluginObject<Perspective>(tlp::QStringToTlpString(perspectiveName), context);
