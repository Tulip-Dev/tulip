...
TulipMainWindow::TulipMainWindow(QWidget *parent) : QMainWindow(parent), _ui(new Ui::TulipMainWindowData()), _systemTrayIcon(0) {
  ...
  _ui->mainTitle->setText(
      QString("<html><head/><body><p align=\"center\"><span style=\" font-family:'MS Shell Dlg 2'; font-size:18pt; font-weight:600;\">") + title +
      "</span></p></body></html>");
...
void TulipMainWindow::closeEvent(QCloseEvent *e) {
  ...
  if (TulipSettings::instance().value("app/showsystraynotif", true).toBool()) {
    showTrayMessage(trUtf8("Tulip"), trUtf8("Tulip is still running.\nTo show the Tulip window again, click Tulip icon located into your "
...
void TulipMainWindow::showOpenProjectWindow() {
  ...
  QString filePath = QFileDialog::getOpenFileName(
      this, trUtf8("Choose a Tulip project to open with its associated perspective. Or select a external file format to import."), QDir::homePath(),
