...
DEFINE_COMPONENT(quazip "QuaZIP" "C++ wrapper over Gilles Vollant's ZIP/UNZIP package that can be used to access ZIP archives" "" ${THIRDPARTY_GROUP_NAME})
...
#library/tulip-qt
DEFINE_COMPONENT(libtulip_qt "Qt bindings" "Tulip Qt provides binding for the Qt4 framework. Helping user to design user interfaces to integrate Tulip 3D visualizations into a GUI." "libtulip;libtulip_ogl;quazip" ${LIBS_GROUP_NAME})
...
#library/tulip-python
DEFINE_COMPONENT(libtulip_python "Python bindings" "Python bindings for Tulip." "siplib" ${LIBS_GROUP_NAME})
...
DEFINE_COMPONENT(tulip_plugins_pythonscriptview "Python view" "Python view plugin" "libtulip_python" ${PLUGINS_GROUP_NAME})
