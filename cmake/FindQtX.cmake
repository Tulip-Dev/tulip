...
IF(${Qt5Widgets_FOUND} AND ${Qt5OpenGL_FOUND} AND ${Qt5Network_FOUND})
  ...
  #check for WebEngine (new web module since Qt 5.4)
  SET(QT_WEBENGINE_WIDGETS_CMAKE_DIR "${QT_CMAKE_DIR}/Qt5WebEngineWidgets")
  IF(EXISTS ${QT_WEBENGINE_WIDGETS_CMAKE_DIR})
  ...
  ENDIF(EXISTS ${QT_WEBENGINE_WIDGETS_CMAKE_DIR})

  # If Qt5 is not bundled with WebEngine then fallback to Webkit  (deprecated since Qt 5.5)
  SET(QT_WEBKIT_WIDGETS_CMAKE_DIR "${QT_CMAKE_DIR}/Qt5WebKitWidgets")
  IF(NOT QT_HAS_WEBENGINE AND EXISTS ${QT_WEBKIT_WIDGETS_CMAKE_DIR})
  ...
  ENDIF(NOT QT_HAS_WEBENGINE AND EXISTS ${QT_WEBKIT_WIDGETS_CMAKE_DIR})
