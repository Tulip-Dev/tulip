  ...
  IF(NOT CLANG OR CMAKE_CXX_COMPILER_VERSION VERSION_GREATER 3.7.0 OR CMAKE_CXX_COMPILER_VERSION VERSION_EQUAL 3.7.0)
    ...
    IF(TULIP_ENABLE_MULTI_THREADING)
      ...
      IF(NOT TULIP_CXX_THREADS)
        ...
        IF(APPLE AND CLANG)
	  STRING(FIND "${CMAKE_C_COMPILER}" "llvm" LLVM_POS)
	  STRING(COMPARE NOTEQUAL "${LLVM_POS}" "-1" BREW_CLANG)
	  IF(BREW_CLANG)
	    ...
	    STRING(REPLACE "/bin/clang" "" LLVM_COMPILER_DIR "${CMAKE_C_COMPILER}")
            SET(CMAKE_C_FLAGS "-DBREW_CLANG -I${LLVM_COMPILER_DIR}/include ${CMAKE_C_FLAGS}" CACHE STRING "" FORCE)
            SET(CMAKE_CXX_FLAGS "-DBREW_CLANG -I${LLVM_COMPILER_DIR}/include ${CMAKE_CXX_FLAGS}" CACHE STRING "" FORCE)
            SET(CMAKE_EXE_LINKER_FLAGS "-L${LLVM_COMPILER_DIR}/lib ${CMAKE_EXE_LINKER_FLAGS}" CACHE STRING "" FORCE)
            SET(CMAKE_SHARED_LINKER_FLAGS "-L${LLVM_COMPILER_DIR}/lib ${CMAKE_SHARED_LINKER_FLAGS}" CACHE STRING "" FORCE)
	  ENDIF(BREW_CLANG)
