    ...
    IF(TULIP_ENABLE_MULTI_THREADING)
	  ...
	  IF(LLVM_POS GREATER -1)
	    ...
	    STRING(REPLACE "/bin/clang" "" LLVM_COMPILER_DIR "${CMAKE_C_COMPILER}")
            SET(CMAKE_C_FLAGS "-I${LLVM_COMPILER_DIR}/include ${CMAKE_C_FLAGS}" CACHE STRING "" FORCE)
            SET(CMAKE_CXX_FLAGS "-I${LLVM_COMPILER_DIR}/include ${CMAKE_CXX_FLAGS}" CACHE STRING "" FORCE)
