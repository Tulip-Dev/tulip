...
color_scale_param_value_dict = {0.0: (255,0,255,255),
                                0.5: (128,255,0,255),
                                1.0: (128,0,255,255)}
color_scale_param_value_list = [(255,0,255,255), (128,255,0,255), (128,0,255,255)]
...
class TestAlgorithm(tlp.Algorithm):
  def __init__(self, context):
    ...
    self.addBooleanParameter(boolean_param_name, defaultValue=str(boolean_param_default_value))
    self.addColorParameter(color_param_name, defaultValue=color_param_default_value)
    self.addColorScaleParameter(color_scale_param_name, defaultValue=color_scale_param_default_value)
    self.addIntegerParameter(int_param_name, defaultValue=str(int_param_default_value))
    self.addFloatParameter(float_param_name, defaultValue=str(float_param_default_value))
    self.addStringParameter(string_param_name, defaultValue=str(string_param_default_value))
    self.addDirectoryParameter(dir_param_name, defaultValue=dir_param_default_value)
    self.addFileParameter(file_param_name, defaultValue=file_param_default_value)
    self.addStringCollectionParameter(string_collection_param_name, defaultValue=string_collection_param_default_value)

    self.addBooleanPropertyParameter(boolean_prop_param_name, defaultValue=boolean_prop_param_default_value)
    self.addColorPropertyParameter(color_prop_param_name, defaultValue=color_prop_param_default_value)
    self.addDoublePropertyParameter(double_prop_param_name, defaultValue=double_prop_param_default_value)
    self.addIntegerPropertyParameter(int_prop_param_name, defaultValue=int_prop_param_default_value)
    self.addLayoutPropertyParameter(layout_prop_param_name, defaultValue=layout_prop_param_default_value)
    self.addSizePropertyParameter(size_prop_param_name, defaultValue=size_prop_param_default_value)
    self.addStringPropertyParameter(string_prop_param_name, defaultValue=string_prop_param_default_value)
    self.addBooleanVectorPropertyParameter(boolean_vec_prop_param_name, defaultValue=boolean_vec_prop_param_default_value)
    self.addColorVectorPropertyParameter(color_vec_prop_param_name, defaultValue=color_vec_prop_param_default_value)
    self.addDoubleVectorPropertyParameter(double_vec_prop_param_name, defaultValue=double_vec_prop_param_default_value)
    self.addIntegerVectorPropertyParameter(int_vec_prop_param_name, defaultValue=int_vec_prop_param_default_value)
    self.addCoordVectorPropertyParameter(coord_vec_prop_param_name, defaultValue=coord_vec_prop_param_default_value)
    self.addSizeVectorPropertyParameter(size_vec_prop_param_name, defaultValue=size_vec_prop_param_default_value)
    self.addStringVectorPropertyParameter(string_vec_prop_param_name, defaultValue=string_vec_prop_param_default_value)
  ...
  def run(self):
    ...
    parameters_value[string_collection_param_name] = self.dataSet[string_collection_param_name]

    parameters_value[color_param_name] = tlp.Color(self.dataSet[color_param_name])
    parameters_value[color_scale_param_name] = tlp.ColorScale(self.dataSet[color_scale_param_name])

    parameters_value[boolean_prop_param_name] = self.dataSet[boolean_prop_param_name]
    parameters_value[color_prop_param_name] = self.dataSet[color_prop_param_name]
    parameters_value[double_prop_param_name] = self.dataSet[double_prop_param_name]
    parameters_value[int_prop_param_name] = self.dataSet[int_prop_param_name]
    parameters_value[layout_prop_param_name] = self.dataSet[layout_prop_param_name]
    parameters_value[size_prop_param_name] = self.dataSet[size_prop_param_name]
    parameters_value[string_prop_param_name] = self.dataSet[string_prop_param_name]
