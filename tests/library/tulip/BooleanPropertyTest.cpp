...
//==========================================================
void BooleanPropertyTest::tearDown() { delete graph; }
//==========================================================
...
void BooleanPropertyTest::testReverse() {
  ...
  CPPUNIT_ASSERT_EQUAL(
      true, selection->getNodeValue(node(graph->numberOfNodes() - 1)));
  ...
  CPPUNIT_ASSERT_EQUAL(
      true, selection->getEdgeValue(edge(graph->numberOfEdges() - 1)));
