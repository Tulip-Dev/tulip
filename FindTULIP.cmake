...
FIND_LIBRARY(TULIP3_COMPAT_LIBRARY "tulip3-compat-${TULIP_VERSION_MAJOR}${TulipVersionSeparator}${TULIP_VERSION_MINOR}"
             PATHS ${TULIP_LIBRARIES_DIR}
             NO_DEFAULT_PATH)

IF((TULIP_OGL_LIBRARY AND NOT TULIP_CORE_LIBRARY) OR (TULIP_GUI_LIBRARY AND NOT TULIP_OGL_LIBRARY) OR (TULIP_OGDF_LIBRARY AND NOT TULIP_CORE_LIBRARY) OR (TULIP_PYTHON_LIBRARY AND NOT TULIP_CORE_LIBRARY) OR (TULIP3_COMPAT_LIBRARY AND NOT TULIP_GUI_LIBRARY))
  ...
  MESSAGE("Tulip3Compat: ${TULIP3_COMPAT_LIBRARY} (depends on TulipCore, TulipGUI and TulipOGL)")
