...
namespace tlp {
  ...
  BaseGraphicsViewComponent::BaseGraphicsViewComponent(const string &realViewName):realViewName(realViewName),graphicsView(NULL),baseView(ViewManager::getPluginObject(realViewName, NULL)){}
