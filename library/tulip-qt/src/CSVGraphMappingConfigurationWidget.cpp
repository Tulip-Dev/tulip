...
void CSVGraphMappingConfigurationWidget::updateWidget(tlp::Graph* graph,const CSVImportParameters& importParameters) {
    ...
    ui->nodeMappingPropertycomboBox->setCurrentIndex(ui->graphIndexPropertiesComboBox->findText("viewLabel"));
    ui->edgeMappingPropertycomboBox->setCurrentIndex(ui->graphIndexPropertiesComboBox->findText("viewLabel"));
    ui->graphIndexPropertiesComboBox->setCurrentIndex(ui->graphIndexPropertiesComboBox->findText("viewLabel"));
}
