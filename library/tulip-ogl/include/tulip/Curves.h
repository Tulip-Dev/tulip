...
TLP_GL_SCOPE void
computeCleanVertices(const std::vector<Coord> &bends, const Coord &startPoint,
...
polyQuad(const std::vector<Coord> &, /* polyline vertces */
         ...
         bool, /* if true : use start and end color to border lines, if false :
                  use borderColor*/
...
TLP_GL_SCOPE void
splineQuad(const std::vector<Coord> &, /* polyline vertces */
           const Color &,              /* start color */
           const Color &,              /* end color */
           const float,                /* start size */
           const float,                /* end size */
...
TLP_GL_SCOPE void splineLine(const std::vector<Coord> &, /* polyline vertces */
                             ...
                             const Color &);             /* end color */
//====================================================================
TLP_GL_SCOPE void getColors(const Coord *line, unsigned int lineSize,
                            const Color &c1, const Color &c2,
                            std::vector<Color> &);
TLP_GL_SCOPE void getSizes(const std::vector<Coord> &line, float s1, float s2,
                           std::vector<float> &);
TLP_GL_SCOPE GLfloat *
buildCurvePoints(const std::vector<Coord> &vertices,
