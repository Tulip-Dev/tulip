 ...
 * along B̩zier curve defined by a set of control points
 *
...
/** Compute a set of points approximating a B̩zier curve
 *
 *  \param controlPoints a vector of control points
 ...
 * \param controlPoints a vector of control points
 * \param t curve parameter value (0 <= t <= 1)
 * \param closedCurve if true, the curve will be closed, meaning a B̩zier segment will connect the last and first control point
...
/**
  ...
  * An uniform B-spline is a piecewise collection of B̩zier curves of the same degree, connected end to end.
  * The features of this type of spline are the following :
