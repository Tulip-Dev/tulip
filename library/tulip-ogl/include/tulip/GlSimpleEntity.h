 ...
 *
 * You don't have to create a GlSimpleEntity, you have to use GlLine, GlRect or
 * GlSphere for example
 * @see Gl2DRect
 * @see GlPolygon
 * @see GlAxis
 * @see GlBezierCurve
...
public:
   ...
   * @brief Draw function
   *
   * @warning You don't have to call this function, the Tulip OpenGL engine call
   * it.
   */
