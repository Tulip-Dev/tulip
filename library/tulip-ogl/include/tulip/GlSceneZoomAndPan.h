...
public :
	 ...
	 *
	 */
	void setNbAnimationSteps(int nbAnimationSteps) {this->nbAnimationSteps = nbAnimationSteps;}
...
public :
  ...
  GlSceneZoomAndPan(GlScene *glScene, const BoundingBox &boundingBox, const std::string &layerName="Main", const int nbAnimationSteps = 50, const bool optimalPath = true, const double p = sqrt(1.6));
	 ...
	 */
	int getNbAnimationsStep() const {return nbAnimationSteps;}

	/**
	 * Method to set the number of animation steps
	 */
	void setNbAnimationSteps(const int nbAnimationSteps) {this->nbAnimationSteps = nbAnimationSteps;}
