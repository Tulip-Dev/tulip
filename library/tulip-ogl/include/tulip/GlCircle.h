...
public:
   ...
   * @brief Constructor
   *
   * @param startAngle if start angle is equal to 0, the circle construction
   * begin with the top center point
  ...
  GlCircle(const Coord &center = Coord(0, 0, 0), float radius = 1.,
           ...
           bool outlined = true, float startAngle = 0.0,
           unsigned int segments = 10);

  /**
   * @brief Write-acess Accessor to the center, the radius and the startAngle of
   * the circle.
   */
