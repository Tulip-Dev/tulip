...
GlProgressBar::GlProgressBar(const Coord &centerPosition, const unsigned int width,
  ...
  Coord globalFrameVertice1(centerPosition.getX() - (width / 2.),
                            centerPosition.getY() + (height / 2.));
  Coord globalFrameVertice2(centerPosition.getX() + (width / 2.),
                            centerPosition.getY() + (height / 2.));
  Coord globalFrameVertice3(centerPosition.getX() + (width / 2.),
                            centerPosition.getY() - (height / 2.));
  Coord globalFrameVertice4(centerPosition.getX() - (width / 2.),
                            centerPosition.getY() - (height / 2.));
  ...
  Coord &&progressBarFrameVertice2 =
      progressBarFrameVertice1 + Coord(progressBarMaxWidth + 2, 0, 0);
  Coord &&progressBarFrameVertice3 =
      progressBarFrameVertice2 + Coord(0, -(progressBarHeight + 2), 0);
