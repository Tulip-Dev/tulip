...
void GlQuadTreeLODCalculator::addObservers() {
  if(inputData) {
    ...
    if(currentGraph->existProperty(inputData->getElementLayoutPropName())) {
    ...
    if(currentGraph->existProperty(inputData->getElementSizePropName())) {
    ...
    if(currentGraph->existProperty(inputData->getElementSelectedPropName())) {
...
void GlQuadTreeLODCalculator::addLocalProperty(Graph*, const std::string &name) {
  if(name==inputData->getElementLayoutPropName() || name==inputData->getElementSizePropName() || name == inputData->getElementSelectedPropName()) {
    setHaveToCompute();
    addObservers();
  }
}
...
void GlQuadTreeLODCalculator::addInheritedProperty(Graph *, const string &name) {
  if(name==inputData->getElementLayoutPropName() || name==inputData->getElementSizePropName() || name == inputData->getElementSelectedPropName()) {
    setHaveToCompute();
    addObservers();
  }
...
void GlQuadTreeLODCalculator::afterDelInheritedProperty(Graph *, const string &name) {
  if(name==inputData->getElementLayoutPropName() || name==inputData->getElementSizePropName() || name == inputData->getElementSelectedPropName()) {
    setHaveToCompute();
    addObservers();
  }
