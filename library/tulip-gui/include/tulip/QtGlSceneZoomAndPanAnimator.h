...
public:
   ...
   * \param optimalPath if true zooming and panning will be combined at each step of the animation, if false the scene will be zoomed out/in, panned
   * then zoomed in/out
   ...
   */
  QtGlSceneZoomAndPanAnimator(GlMainWidget *glWidget, const BoundingBox &boundingBox, const double duration = 1000., const bool optimalPath = true,
                              const double velocity = 1.1, const double p = sqrt(1.6));
