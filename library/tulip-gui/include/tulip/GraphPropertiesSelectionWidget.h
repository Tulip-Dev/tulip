...
public :
   ...
   */
  GraphPropertiesSelectionWidget(QWidget *parent = nullptr, const StringsListSelectionWidget::ListType &listType = StringsListSelectionWidget::SIMPLE_LIST,
   ...
   */
  GraphPropertiesSelectionWidget(Graph *graph, QWidget *parent = nullptr, const StringsListSelectionWidget::ListType &listType = StringsListSelectionWidget::SIMPLE_LIST,
