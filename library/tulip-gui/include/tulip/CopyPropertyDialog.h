...
public:
  ...
  /**
    * @brief Perform the copy of the property in function of the parameters given by user. If parameters are invalid return a null pointer and fill
    *the errorMsg with the description of the error.
    *
    * This function don't hold observers during the copy process. It's up to user to call Observable::holdObserver and Observable::unholdObserver
    *before and after calling this funtion.
    **/
  ...
  /**
    * @brief This is a convenience static function that copy property in function of user parameters. If the user presses Cancel or an error occur, it
    ...
    * @param askBeforePropertyOverwriting If set to true and user try to create a new property with the same name than another existing ask user
    *before overwriting them.
    **/
  static PropertyInterface *copyProperty(tlp::Graph *graph, tlp::PropertyInterface *source, bool askBeforePropertyOverwriting = false,
