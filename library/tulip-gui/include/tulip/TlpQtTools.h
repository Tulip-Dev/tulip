...
/**
    ...
    * The package name uses the Tulip release, platform (windows, unix, ...), architecture (x86, x86_64), and compiler used (GCC, Clang, MSVC) to
  *determine which package this version can use.
    *
...
/**
 ...
 @endlist
 */
extern TLP_QT_SCOPE void initTulipSoftware(PluginLoader *loader = nullptr, bool removeDiscardedPlugins = false);
