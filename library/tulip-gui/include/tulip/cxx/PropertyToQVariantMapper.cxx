...
QVariant StandardPropertyToQVariantConverter<PropertyClass, NodeType, EdgeType>::getValue(unsigned int id, tlp::ElementType elementType,
...
template <typename PropertyClass, typename NodeType, typename EdgeType>
QVariant StandardPropertyToQVariantConverter<PropertyClass, NodeType, EdgeType>::getNormalizedValue(unsigned int, tlp::ElementType,
                                                                                                    tlp::PropertyInterface *, tlp::Graph *) const {
  return QVariant();
}

template <typename PropertyClass, typename NodeType, typename EdgeType>
bool StandardPropertyToQVariantConverter<PropertyClass, NodeType, EdgeType>::setValue(unsigned int id, tlp::ElementType elementType,
                                                                                      tlp::PropertyInterface *property, const QVariant &data) const {
...
template <typename PropertyClass, typename NodeType, typename EdgeType>
bool StandardPropertyToQVariantConverter<PropertyClass, NodeType, EdgeType>::setAllValue(tlp::ElementType elementType,
