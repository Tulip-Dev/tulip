...
CaptionGraphicsBackgroundItem::CaptionGraphicsBackgroundItem(const QRect &rect)
    : QGraphicsRectItem(rect), _interactionsActivated(false), _beginBackup(0.), _endBackup(1.), _captionContentPos(50, 20) {
  ...
  _middleCaptionRectItem =
      new MovableRectItem(QRect(_captionContentPos, QSize(30, 160)), QRect(0, 0, 1, 1), _rangeSelector1Item, _rangeSelector2Item);
  ...
  _sizeCaptionPathItem =
      new MovablePathItem(QRect(0, 0, 1, 1), _topSizeCaptionPathItem, _bottomSizeCaptionPathItem, _rangeSelector1Item, _rangeSelector2Item);
...
void CaptionGraphicsBackgroundItem::generateColorCaption(const QGradient &activeGradient, const QGradient &hideGradient,
...
void CaptionGraphicsBackgroundItem::generateSizeCaption(const vector<pair<double, float>> &metricToSizeFilteredList, const string & /*propertyName*/,
...
SelectionArrowItem::SelectionArrowItem(float initRangePos, const QPoint &initPos) : QGraphicsPathItem(), yPos(initRangePos * 160), initPos(initPos) {
...
MovablePathItem::MovablePathItem(const QRectF &rect, QGraphicsPathItem *topPathItem, QGraphicsPathItem *bottomPathItem, SelectionArrowItem *topCircle,
                                 SelectionArrowItem *bottomCircle)
    : QGraphicsPathItem(), _currentRect(rect), _topPathItem(topPathItem), _bottomPathItem(bottomPathItem), _topCircle(topCircle),
