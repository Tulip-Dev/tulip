...
NodeLinkDiagramComponent::NodeLinkDiagramComponent(const tlp::PluginContext*): _grid(nullptr), _gridOptions(nullptr),_hasHulls(false),_tooltips(false),grid_ui(nullptr) {
}
