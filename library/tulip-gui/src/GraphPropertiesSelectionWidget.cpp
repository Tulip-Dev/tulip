...
void GraphPropertiesSelectionWidget::setInputPropertiesList(
    const vector<string> &inputPropertiesList) {
...
void GraphPropertiesSelectionWidget::setOutputPropertiesList(
    const vector<string> &outputPropertiesList) {
