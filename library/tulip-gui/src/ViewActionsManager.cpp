...
ViewActionsManager::ViewActionsManager(View *view, GlMainWidget *widget, bool keepRatio, bool showAAA)
  : _view(view), _glMainWidget(widget), _keepSizeRatio(keepRatio), _advAntiAliasingAction(nullptr) {
