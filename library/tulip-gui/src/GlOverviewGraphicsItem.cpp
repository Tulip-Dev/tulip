...
GlOverviewGraphicsItem::GlOverviewGraphicsItem(GlMainView *view, GlScene &scene)
    : QGraphicsRectItem(0, 0, 128, 128), view(view), baseScene(scene), width(128), height(128), mouseClicked(false), _frameColor(Color::Gray),
      _frameWidth(2), _generatePixmap(true) {
}
