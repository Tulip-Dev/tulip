...
const Coord twoArrowWithLine[] = {Coord(0, 0, 0), Coord(5, -5, 0), Coord(-5, -5, 0), Coord(0, 0, 0),  Coord(-5, 0, 0),
                                  Coord(5, 0, 0), Coord(0, 0, 0),  Coord(5, 5, 0),   Coord(-5, 5, 0), Coord(0, 0, 0)};

//========================================================================================
MouseSelectionEditor::MouseSelectionEditor() : glMainWidget(nullptr), layer(nullptr), composite(nullptr) {
  operation = NONE;
...
bool MouseSelectionEditor::eventFilter(QObject *widget, QEvent *e) {
  ...
  if (e->type() == QEvent::MouseButtonPress) {
    ...
    case Qt::LeftButton: {
      ...
      if (!hasSelection || (!glMainWidget->pickGlEntities((int)editPosition[0] - 3, (int)editPosition[1] - 3, 6, 6, select, layer))) {
  ...
  if (e->type() == QEvent::MouseButtonRelease && qMouseEv->button() == Qt::LeftButton && operation != NONE) {
    stopEdition();
