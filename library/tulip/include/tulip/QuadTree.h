...
namespace tlp {
  ...
  private:
    ...
    Rectangle<float> getChildBox(int i) {
      ...
      // 3 => FHDE
      Vec2f I;
      I[0] = (_box[0][0] + _box[1][0]) / 2.f;
      I[1] = _box[0][1];
      Vec2f E;
      E[0] =  _box[0][0];
      E[1] = (_box[0][1] + _box[1][1]) / 2.f;
      Vec2f F;
      F[0] = I[0];
      F[1] = E[1];
      Vec2f G;
      ...
      H[1] = _box[1][1];
      switch(i) {
      case 0: return Rectangle<float>(_box[0], F); break;
      case 1: return Rectangle<float>(I, G); break;
      case 2: return Rectangle<float>(F, _box[1]); break;
      case 3: return Rectangle<float>(E, H);
