...
#ifndef TULIP_PLANARITY_H
#define TULIP_PLANARITY_H
...
public:
  static bool isPlanar(SuperGraph *graph, bool, bool);
...
private:
  ...
  PlanarityTest(bool e, bool b){embed = e; biconnected = b;}
  static PlanarityTest * instance;
  stdext::hash_map<unsigned int,bool> resultsBuffer;

  void init(SuperGraph*);
  void restore(SuperGraph*);
