...
namespace {
    ...
    struct Node2Observable {
        tlpext::Observable* operator()(tlp::node n) {
            return dynamic_cast<tlpext::Observable*>(object[n]);
        }
        tlp::NodeProperty<tlpext::OLOObject *> object;
    } node2Observable;
    //======================================================================
    struct Node2Onlooker {
        tlpext::Onlooker* operator()(tlp::node n) {
            return dynamic_cast<tlpext::Onlooker*>(object[n]);
        }
        tlp::NodeProperty<tlpext::OLOObject *> object;
    } node2Onlooker;
    //======================================================================
