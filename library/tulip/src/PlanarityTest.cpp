...
#endif
//=================================================================
bool PlanarityTest::isPlanar(SuperGraph *graph, bool e, bool b){
  if(instance==0)
    instance=new PlanarityTest(e, b);
...
bool PlanarityTest::compute(SuperGraph *graph) { 
  ...
  //bool planar = true;
  resultsBuffer[(unsigned int)graph]=planar;
  return planar;
}
...
//=================================================================
void PlanarityTest::restore(SuperGraph *graph){
  ...
  map<edge,edge>::iterator it2;
  for (it2 = bidirectedEdges.begin(); it2!=bidirectedEdges.end(); ++it2) {
    graph->delEdge(it2->first);
  }
}

//=================================================================
void PlanarityTest::init(SuperGraph *graph) {
...
//=================================================================
void PlanarityTest::findTerminalNodes(SuperGraph *sG, node n, 
				      list<node> &listOfComponents,
				      map<node , list<node> > &terminalNodes) {
...
//=================================================================
bool PlanarityTest::findObstruction(SuperGraph *sG, node n, list<node>& terminalNodes)
{
  //  cerr << __PRETTY_FUNCTION__ << endl;
...
//=================================================================
void PlanarityTest::setInfoForNewCNode(SuperGraph *sG,
				       node n,
				       node newCNode,
