...
public:
  ...
  virtual void setAllNodeValue(tlp::StoredType<int>::ReturnedConstValue v, const Graph *graph = NULL);
  virtual void setAllEdgeValue(tlp::StoredType<int>::ReturnedConstValue v, const Graph *graph = NULL);
