 ...
 */
template <typename Obj, typename OTYPE> struct Circle : public Vector<Obj, 2, OTYPE> {
  Circle() {
  }
...
bool intersection(const tlp::Circle<Obj, OTYPE> &c1, const tlp::Circle<Obj, OTYPE> &c2, tlp::Vector<Obj, 2, OTYPE> &sol1,
 ...
 */
template <typename Obj, typename OTYPE> tlp::Circle<Obj, OTYPE> enclosingCircle(const tlp::Circle<Obj, OTYPE> &, const tlp::Circle<Obj, OTYPE> &);

/**
 * Compute the optimum enclosing circle of a set of circles.
 */
template <typename Obj, typename OTYPE> tlp::Circle<Obj, OTYPE> enclosingCircle(const std::vector<tlp::Circle<Obj, OTYPE>> &circles);
/**
 * Compute an enclosing circle of a set of circles,
 * this algorithm is an aproximation of the smallest
 * enclosing circle.
 */
template <typename Obj, typename OTYPE> tlp::Circle<Obj, OTYPE> lazyEnclosingCircle(const std::vector<tlp::Circle<Obj, OTYPE>> &circles);
/**
 * Write circle in a stream
 */
template <typename Obj, typename OTYPE> std::ostream &operator<<(std::ostream &os, const tlp::Circle<Obj, OTYPE> &);
