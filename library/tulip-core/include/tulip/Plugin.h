 ...
 *
 * This classe also holds extra informations about the Tulip system such as the library version the plugin was built against.
 ...
 * @brief Declare meta-informations for a plugin
 * This is an helper macro that defines every function related to a plugin meta-informations (Plugin name, author, etc).
