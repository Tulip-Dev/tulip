 ...
 * This interface is not intended to be directly subclassed. Plugin objects are mainly used
 * internally into the plugin lister system.
 *
 * This class also holds extra information about the Tulip system such as the library version the
 ...
 *
 * @see tlp::WithParameters for the declaration and retrieval of parameters
 * @see tlp::WithDependencies for the declaration and retrieval of dependencies
 * @see tlp::PluginFactory for plugin creation and registration
 * @see tlp::PluginContext and its subclasses for passing runtime parameters.
 *
 * @see tlp::Algorithm for plugins operating on the tlp::Graph structure.
 * @see tlp::PropertyAlgorithm and its subclasses for plugins operating on graph properties
