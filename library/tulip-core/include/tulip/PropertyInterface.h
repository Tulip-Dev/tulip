...
public:
   ...
   */
  virtual bool setAllNodeStringValue( const std::string & value, const Graph *graph = NULL ) = 0;
   ...
   * @return Whether the given string was a correct representation for this property's type. If not, the values are not set.
   */
  virtual bool setAllEdgeStringValue( const std::string & value, const Graph *graph = NULL ) = 0;
