...
public:
  ...
  static bool read(std::istream &, RealType &, char openChar = '(', char sepChar = ',', char closeChar = ')');
...
template <typename T> struct KnownTypeSerializer : public TypedDataSerializer<typename T::RealType> {
