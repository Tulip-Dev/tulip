...
/**
 * @ingroup Checks
 * @brief Performs a test of biconnexity on the graph, and provides a function
 *to make a graph biconnected. From Wikipedia: "A biconnected graph is connected
 *and nonseparable, meaning that if any vertex were to be removed, the graph
...
public:
  /**
   * @brief Checks whether the graph is biconnected (i.e. removing one edge does
   *not disconnect the graph, at least two must be removed).
   *
