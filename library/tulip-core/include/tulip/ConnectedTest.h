 ...
 * From Wikipedia: "A graph is said to be connected if every pair of vertices in the graph are connected." (i.e. there is a path between every pair of
 *vertices).
 **/
...
public:
   ...
   * @return void
   * @note The components parameter can be returned with c++11 thanks to move constructors without performance loss, chenge this function once c++11
   *compilers are used.
   **/
