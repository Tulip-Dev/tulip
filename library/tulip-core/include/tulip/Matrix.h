 ...
 */
template <typename Obj, unsigned int SIZE> class Matrix : public Array<Vector<Obj, SIZE>, SIZE> {
public:
  Matrix() {
  }
 ...
 */
template <typename Obj, unsigned int SIZE> inline MATRIX operator+(const MATRIX &mat1, const MATRIX &mat2);
/**
 ...
 * obj
 */
template <typename Obj, unsigned int SIZE> inline MATRIX operator*(const MATRIX &mat, const Obj &obj);
/**
 * Returns a new matrix equal to the multiplication of the matrix by
 * another matrix
 */
 ...
 */
template <typename Obj, unsigned int SIZE> inline Vector<Obj, SIZE> operator*(const Vector<Obj, SIZE> &vec, const tlp::Matrix<Obj, SIZE> &);
/**
 * Returns a new vector equal to the multiplication of the matrix by
 * a vector
 */
template <typename Obj, unsigned int SIZE> inline Vector<Obj, SIZE> operator*(const Matrix<Obj, SIZE> &, const Vector<Obj, SIZE> &vec);
}
