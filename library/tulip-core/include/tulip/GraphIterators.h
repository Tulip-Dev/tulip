...
class TLP_SCOPE OutNodesIterator : public FactorNodeIterator,
...
class TLP_SCOPE OutEdgesIterator : public FactorEdgeIterator,
...
class TLP_SCOPE InEdgesIterator : public FactorEdgeIterator,
