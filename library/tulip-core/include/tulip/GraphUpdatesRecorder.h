...
namespace std {
template <> struct less<tlp::GraphEltsRecord *> {
...
//
  ...
  struct RecordedValues {
    ...
    RecordedValues(PropertyInterface *prop = nullptr, MutableContainer<bool> *rn = nullptr, MutableContainer<bool> *re = nullptr)
...
public:
  GraphUpdatesRecorder(bool allowRestart = true, const GraphStorageIdsMemento *prevIdsMemento = nullptr);
