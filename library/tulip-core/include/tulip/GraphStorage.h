...
public:
  ...
  //=======================================================
  /**
   * @brief Return the edges in the graph
   */
  ...
  //=======================================================
  /**
   * @brief Return the nodes in the graph
   */
   ...
   * these structures will be devalidated.
   */
  void addEdges(const std::vector<std::pair<node, node>> &edges, std::vector<edge> *addedEdges = NULL);
  //=======================================================
  /**
