...
VECTORTLP tlp::operator^(const VECTORTLP &u, const VECTORTLP &v) {
  ...
  case 3:
    return VECTORTLP(
        static_cast<TYPE>(static_cast<OTYPE>(u.y()) * static_cast<OTYPE>(v.z()) - static_cast<OTYPE>(u.z()) * static_cast<OTYPE>(v.y())),
        static_cast<TYPE>(static_cast<OTYPE>(u.z()) * static_cast<OTYPE>(v.x()) - static_cast<OTYPE>(u.x()) * static_cast<OTYPE>(v.z())),
        static_cast<TYPE>(static_cast<OTYPE>(u.x()) * static_cast<OTYPE>(v.y()) - static_cast<OTYPE>(u.y()) * static_cast<OTYPE>(v.x())));
    break;
...
TYPE VECTORTLP::norm() const {
  ...
  case 3:
    return tlpsqrt<TYPE, OTYPE>(tlpsqr<TYPE, OTYPE>(x()) + tlpsqr<TYPE, OTYPE>(y()) + tlpsqr<TYPE, OTYPE>(z()));
...
DTYPE VECTORTLP::dist(const VECTOR &c) const {
  ...
  case 2:
    return tlpsqrt<DTYPE, OTYPE>(tlpsqr<DTYPE, OTYPE>(x() - c.x()) + tlpsqr<DTYPE, OTYPE>(y() - c.y()));

  case 3:
    return tlpsqrt<DTYPE, OTYPE>(tlpsqr<DTYPE, OTYPE>(x() - c.x()) + tlpsqr<DTYPE, OTYPE>(y() - c.y()) + tlpsqr<DTYPE, OTYPE>(z() - c.z()));
