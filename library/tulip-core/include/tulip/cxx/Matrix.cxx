...
//===================================================================
template <typename Obj, unsigned int SIZE> MATRIX::Matrix(const std::vector<std::vector<Obj>> &covarianceMatrix) {
...
//===================================================================
template <typename Obj, unsigned int SIZE> MATRIX &MATRIX::fill(Obj obj) {
  for (unsigned int i = 0; i < SIZE; ++i)
    (*this)[i].fill(obj);
...
//======================================================
template <typename Obj, unsigned int SIZE> MATRIX &MATRIX::operator+=(const MATRIX &mat) {
  for (unsigned int i = 0; i < SIZE; ++i)
    (*this)[i] += mat[i];
...
//======================================================
template <typename Obj, unsigned int SIZE> bool MATRIX::operator==(const MATRIX &mat) const {
  for (unsigned int i = 0; i < SIZE; ++i) {
    if (((*this)[i] != mat[i]))
      return false;
  }
...
//=====================================================================================
template <typename Obj, unsigned int SIZE> MATRIX &MATRIX::operator*=(const Obj &obj) {
  for (unsigned int i = 0; i < SIZE; ++i)
    (*this)[i] *= obj;
...
//=====================================================================================
template <typename Obj, unsigned int SIZE> Obj MATRIX::determinant() const {
  switch (SIZE) {
  case 2:
...
//=====================================================================================
template <typename Obj, unsigned int SIZE> MATRIX MATRIX::cofactor() const {
  MATRIX result;
...
//=====================================================================================
template <typename Obj, unsigned int SIZE> MATRIX &MATRIX::transpose() {
  Obj tmp;
...
//=====================================================================================
template <typename Obj, unsigned int SIZE> MATRIX &MATRIX::inverse() {
...
//=====================================================================================
template <typename Obj, unsigned int SIZE> MATRIX MATRIX::operator/(const MATRIX &mat2) const {
  return MATRIX(*this) /= mat2;
}
//=====================================================================================
template <typename Obj, unsigned int SIZE> MATRIX MATRIX::operator/(const Obj &obj) const {
...
//=====================================================================================
template <typename Obj, unsigned int SIZE> tlp::Vector<Obj, SIZE> tlp::operator*(const MATRIX &mat, const tlp::Vector<Obj, SIZE> &vec) {
...
//=====================================================================================
template <typename Obj, unsigned int SIZE> tlp::Vector<Obj, SIZE> tlp::operator*(const tlp::Vector<Obj, SIZE> &vec, const MATRIX &mat) {
  tlp::Vector<Obj, SIZE> result;
...
//=====================================================================================
template <typename Obj, unsigned int SIZE> tlp::Vector<Obj, SIZE> MATRIX::powerIteration(const unsigned int nIterations) const {
...
template <typename Obj, unsigned int SIZE> bool MATRIX::simplify(tlp::Matrix<Obj, 2> &simplifiedMatrix) const {
  if (SIZE != 3) {
...
template <typename Obj, unsigned int SIZE> bool MATRIX::computeEigenVector(const float x, tlp::Vector<Obj, 3> &eigenVector) const {
  if (SIZE != 2) {
