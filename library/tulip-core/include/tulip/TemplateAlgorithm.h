 ...
 *
 * A TemplateAlgorithm takes a graph as input (plus additional parameters defined via tlp::WithParameter) and outputs its results in a
 * tlp::PropertyInterface subclass.
 ...
 */
template <class Property> class TLP_SCOPE TemplateAlgorithm : public PropertyAlgorithm {
public:
  Property *result;
