...
template <typename PROPERTYTYPE, typename NodeType, typename EdgeType> class ComplexValueWrapper {
public:
...
template <typename PROPERTYTYPE, typename NodeType, typename EdgeType> class ComplexPropertyWrapper {
public:
