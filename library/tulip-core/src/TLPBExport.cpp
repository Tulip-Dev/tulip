  ...
  // write properties
  {
    ...
    for (unsigned int i = 0; i < numProperties; ++i) {
      ...
      // write nodes values
      {
        ...
        size = 0;
        // convenient method 'virtual unsigned int tlp::Graph::numberOfNonDefaultValuatedNodes(tlp::Graph *graph=NULL)'
        // has been added in Tulip 4.8 (can not be backported for maintaining binary compatibility)
      ...
      // write edges values
      {
        // write nb of non default values
        edge e;
        // convenient method 'virtual unsigned int tlp::Graph::numberOfNonDefaultValuatedEdges(tlp::Graph *graph=NULL)'
        // has been added in Tulip 4.8 (can not be backported for maintaining binary compatibility)
        size = 0;
