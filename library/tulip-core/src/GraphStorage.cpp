...
//=======================================================
void GraphStorage::getInOutEdges(const node n, std::vector<edge> &edges, bool loopsOnlyOnce) const {
 ...
 */
void GraphStorage::restoreEdges(const std::vector<edge> &rEdges, const std::vector<std::pair<node, node>> &ends) {
  assert(rEdges.size());
