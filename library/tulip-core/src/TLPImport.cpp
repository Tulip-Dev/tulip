...
public:
  PLUGININFORMATION("TLP Import","Auber","16/02/2001",
                    "Import a graph recorded in a file using the TLP format (Tulip Software Graph Format).<br/>See <b>tulip-software.org->Framework->TLP File Format</b> for description.<br/>Note: When using the Tulip graphical user interface,<br/>choosing <b>File->Import->TLP</b> menu item is the same as using <b>File->Open</b> menu item.",
                    "1.0", "File")
