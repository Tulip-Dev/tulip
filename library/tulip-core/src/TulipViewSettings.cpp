...
TulipViewSettings::TulipViewSettings()
    : _defaultNodeColor(Color::Red), _defaultEdgeColor(Color::Black), _defaultNodeBorderColor(Color::Black), _defaultEdgeBorderColor(Color::Black),
      _defaultLabelColor(Color::Black), _defaultLabelBorderColor(Color::Black), _defaultNodeBorderWidth(0), _defaultEdgeBorderWidth(0),
      _defaultLabelBorderWidth(1), _defaultLabelPosition(LabelPosition::Center), _defaultNodeSize(Size(1, 1, 1)),
      _defaultEdgeSize(Size(0.125, 0.125, 0.5)), _defaultNodeShape(NodeShape::Circle), _defaultEdgeShape(EdgeShape::Polyline),
      _defaultEdgeExtremitySrcShape(EdgeExtremityShape::None), _defaultEdgeExtremityTgtShape(EdgeExtremityShape::Arrow),
      _defaultEdgeExtremitySrcSize(Size(1, 1, 0)), _defaultEdgeExtremityTgtSize(Size(1, 1, 0)), _defaultFontFile(tlp::TulipBitmapDir + "font.ttf"),
      _defaultFontSize(18) {
}
