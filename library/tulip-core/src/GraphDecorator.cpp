...
//============================================================
bool GraphDecorator::hasEdge(const node n, const node m, bool directed) const {
...
//============================================================
void GraphDecorator::addEdges(const std::vector<std::pair<node, node>> &edges, std::vector<edge> &addedEdges) {
...
//----------------------------------------------------------------
void GraphDecorator::push(bool unpopAllowed, std::vector<PropertyInterface *> *propertiesToPreserveOnPop) {
