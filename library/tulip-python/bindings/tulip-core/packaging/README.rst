...
tool allowing to easily create quality Python bindings for any C/C++ library.
The main features provided by the bindings are the following ones:
  ...
  - **Application of algorithms of different types on graph** :
    ...
    graph layout algorithms but also a bridge to the Open Graph Drawing Framework (https://github.com/ogdf/ogdf) [5]_
