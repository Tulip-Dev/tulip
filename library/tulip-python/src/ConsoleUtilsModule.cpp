...
static int consoleutils_ConsoleOutput_init(consoleutils_ConsoleOutput *self, PyObject *args, PyObject *) {
  int i;
...
static PyMemberDef consoleutils_ConsoleOutput_members[] = {
    ...
    {const_cast<char *>("writeToConsole"), T_BOOL, offsetof(consoleutils_ConsoleOutput, writeToConsole), 0,
     const_cast<char *>("flag for enabling/disabling console output")},
    {0, 0, 0, 0, 0} /* Sentinel */
};

static PyMethodDef consoleutils_ConsoleOutput_methods[] = {
    {"write", (PyCFunction)consoleutils_ConsoleOutput_write, METH_VARARGS, "Post output to the scripting engine"},
    {"enableConsoleOutput", (PyCFunction)consoleutils_ConsoleOutput_enableConsoleOutput, METH_VARARGS, "enable / disable console output"},
...
static PyMethodDef consoleutils_ConsoleInput_methods[] = {
    {"readline", (PyCFunction)consoleutils_ConsoleInput_readline, METH_VARARGS, "read an input line from the console"}, {0, 0, 0, 0} /* Sentinel */
};
