...
static PyObject *consoleutils_ConsoleOutput_new(PyTypeObject *type, PyObject *,
                                                PyObject *) {
  consoleutils_ConsoleOutput *self;
  self =
      reinterpret_cast<consoleutils_ConsoleOutput *>(type->tp_alloc(type, 0));
  self->stderrflag = false;
  self->writeToConsole = true;
  return reinterpret_cast<PyObject *>(self);
}

static int consoleutils_ConsoleOutput_init(consoleutils_ConsoleOutput *self,
...
static PyObject *consoleutils_ConsoleOutput_write(PyObject *self, PyObject *o) {
  ...
  bool stdErr =
      reinterpret_cast<consoleutils_ConsoleOutput *>(self)->stderrflag;
  ...
  if ((PythonInterpreter::getInstance()->outputEnabled() && !stdErr) ||
    ...
    if (buf != NULL &&
        reinterpret_cast<consoleutils_ConsoleOutput *>(self)->writeToConsole) {
...
static PyObject *consoleutils_ConsoleOutput_enableConsoleOutput(PyObject *self,
                                                                PyObject *o) {
  int i;
...
static PyMemberDef consoleutils_ConsoleOutput_members[] = {
    {const_cast<char *>("stderrflag"), T_BOOL,
     offsetof(consoleutils_ConsoleOutput, stderrflag), 0,
...
static PyMethodDef consoleutils_ConsoleOutput_methods[] = {
    {"write", static_cast<PyCFunction>(consoleutils_ConsoleOutput_write),
     METH_VARARGS, "Post output to the scripting engine"},
    {"enableConsoleOutput",
     static_cast<PyCFunction>(consoleutils_ConsoleOutput_enableConsoleOutput),
     METH_VARARGS, "enable / disable console output"},
    {"flush", static_cast<PyCFunction>(consoleutils_ConsoleOutput_flush),
     METH_VARARGS, ""},
...
static PyTypeObject consoleutils_ConsoleOutputType = {
    ...
    reinterpret_cast<destructor>(
        consoleutils_ConsoleOutput_dealloc),  /*tp_dealloc*/
    0,                                        /*tp_print*/
    0,                                        /*tp_getattr*/
    0,                                        /*tp_setattr*/
    0,                                        /*tp_compare*/
...
static PyObject *consoleutils_ConsoleInput_new(PyTypeObject *type, PyObject *,
                                               PyObject *) {
  return type->tp_alloc(type, 0);
}

static int consoleutils_ConsoleInput_init(consoleutils_ConsoleInput *,
                                          PyObject *, PyObject *) {
  return 0;
}
...
static PyMethodDef consoleutils_ConsoleInput_methods[] = {
    {"readline", static_cast<PyCFunction>(consoleutils_ConsoleInput_readline),
     METH_VARARGS, "read an input line from the console"},
    {NULL, NULL, 0, NULL} /* Sentinel */
};
...
static PyTypeObject consoleutils_ConsoleInputType = {
    ...
    0,                                                          /*tp_itemsize*/
    reinterpret_cast<destructor>(
        consoleutils_ConsoleInput_dealloc),   /*tp_dealloc*/
    0,                                        /*tp_print*/
    0,                                        /*tp_getattr*/
    0,                                        /*tp_setattr*/
    0,                                        /*tp_compare*/
