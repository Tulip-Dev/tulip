...
static std::unordered_map<std::string, std::string> &getTypenamesMap() {
  ...
  ret[tlp::demangleClassName(typeid(std::vector<int>).name())] =
      "std::vector<int>";
  ret[tlp::demangleClassName(typeid(std::vector<unsigned int>).name())] =
      "std::vector<uint>";
  ret[tlp::demangleClassName(typeid(std::vector<long>).name())] =
      "std::vector<long>";
  ret[tlp::demangleClassName(typeid(std::vector<unsigned long>).name())] =
      "std::vector<unsigned long>";
  ret[tlp::demangleClassName(typeid(std::vector<float>).name())] =
      "std::vector<float>";
  ret[tlp::demangleClassName(typeid(std::vector<double>).name())] =
      "std::vector<double>";
  ret[tlp::demangleClassName(typeid(std::vector<bool>).name())] =
      "std::vector<bool>";
  ret[tlp::demangleClassName(typeid(std::vector<std::string>).name())] =
      "std::vector<std::string>";
  ret[tlp::demangleClassName(typeid(std::vector<tlp::node>).name())] =
      "std::vector<tlp::node>";
  ret[tlp::demangleClassName(typeid(std::vector<tlp::edge>).name())] =
      "std::vector<tlp::edge>";
  ret[tlp::demangleClassName(typeid(std::vector<tlp::Coord>).name())] =
      "std::vector<tlp::Coord>";
  ret[tlp::demangleClassName(typeid(std::vector<tlp::Color>).name())] =
      "std::vector<tlp::Color>";
  ret[tlp::demangleClassName(typeid(std::vector<tlp::Size>).name())] =
      "std::vector<tlp::Size>";
  ...
  ret[tlp::demangleClassName(
      typeid(std::vector<tlp::StringCollection>).name())] =
      "std::vector<tlp::StringCollection>";
  ret[tlp::demangleClassName(
      typeid(std::vector<tlp::BooleanProperty *>).name())] =
      "std::vector<tlp::BooleanProperty *>";
  ret[tlp::demangleClassName(
      typeid(std::vector<tlp::ColorProperty *>).name())] =
      "std::vector<tlp::ColorProperty *>";
  ret[tlp::demangleClassName(
      typeid(std::vector<tlp::DoubleProperty *>).name())] =
      "std::vector<tlp::DoubleProperty *>";
  ret[tlp::demangleClassName(
      typeid(std::vector<tlp::IntegerProperty *>).name())] =
      "std::vector<tlp::IntegerProperty *>";
  ret[tlp::demangleClassName(
      typeid(std::vector<tlp::LayoutProperty *>).name())] =
  ...
  ret[tlp::demangleClassName(
      typeid(std::vector<tlp::StringProperty *>).name())] =
      "std::vector<tlp::StringProperty *>";
  ret[tlp::demangleClassName(
      typeid(std::vector<tlp::PropertyInterface *>).name())] =
      "std::vector<tlp::PropertyInterface *>";
  ret[tlp::demangleClassName(typeid(std::list<int>).name())] = "std::list<int>";
  ret[tlp::demangleClassName(typeid(std::list<unsigned int>).name())] =
      "std::list<uint>";
  ret[tlp::demangleClassName(typeid(std::list<long>).name())] =
      "std::list<long>";
  ret[tlp::demangleClassName(typeid(std::list<unsigned long>).name())] =
      "std::list<unsigned long>";
  ret[tlp::demangleClassName(typeid(std::list<float>).name())] =
      "std::list<float>";
  ret[tlp::demangleClassName(typeid(std::list<double>).name())] =
      "std::list<double>";
  ret[tlp::demangleClassName(typeid(std::list<bool>).name())] =
      "std::list<bool>";
  ret[tlp::demangleClassName(typeid(std::list<std::string>).name())] =
      "std::list<std::string>";
  ret[tlp::demangleClassName(typeid(std::list<tlp::node>).name())] =
      "std::list<tlp::node>";
  ret[tlp::demangleClassName(typeid(std::list<tlp::edge>).name())] =
      "std::list<tlp::edge>";
  ret[tlp::demangleClassName(typeid(std::list<tlp::Coord>).name())] =
      "std::list<tlp::Coord>";
  ret[tlp::demangleClassName(typeid(std::list<tlp::Color>).name())] =
      "std::list<tlp::Color>";
  ret[tlp::demangleClassName(typeid(std::list<tlp::Size>).name())] =
      "std::list<tlp::Size>";
  ret[tlp::demangleClassName(typeid(std::list<tlp::Graph *>).name())] =
      "std::list<tlp::Graph*>";
  ...
  ret[tlp::demangleClassName(
      typeid(std::list<tlp::BooleanProperty *>).name())] =
  ...
  ret[tlp::demangleClassName(
      typeid(std::list<tlp::IntegerProperty *>).name())] =
  ...
  ret[tlp::demangleClassName(
      typeid(std::list<tlp::PropertyInterface *>).name())] =
      "std::list<tlp::PropertyInterface *>";
  ret[tlp::demangleClassName(typeid(std::set<int>).name())] = "std::set<int>";
  ret[tlp::demangleClassName(typeid(std::set<unsigned int>).name())] =
      "std::set<uint>";
  ret[tlp::demangleClassName(typeid(std::set<long>).name())] = "std::set<long>";
  ret[tlp::demangleClassName(typeid(std::set<unsigned long>).name())] =
      "std::set<unsigned long>";
  ret[tlp::demangleClassName(typeid(std::set<float>).name())] =
      "std::set<float>";
  ret[tlp::demangleClassName(typeid(std::set<double>).name())] =
      "std::set<double>";
  ret[tlp::demangleClassName(typeid(std::set<std::string>).name())] =
      "std::set<std::string>";
  ret[tlp::demangleClassName(typeid(std::set<tlp::node>).name())] =
      "std::set<tlp::node>";
  ret[tlp::demangleClassName(typeid(std::set<tlp::edge>).name())] =
      "std::set<tlp::edge>";
  ret[tlp::demangleClassName(typeid(std::set<tlp::Coord>).name())] =
      "std::set<tlp::Coord>";
  ret[tlp::demangleClassName(typeid(std::set<tlp::Color>).name())] =
      "std::set<tlp::Color>";
  ret[tlp::demangleClassName(typeid(std::set<tlp::Size>).name())] =
      "std::set<tlp::Size>";
  ret[tlp::demangleClassName(typeid(std::set<tlp::Graph *>).name())] =
      "std::set<tlp::Graph*>";
  return ret;
}

static std::unordered_map<std::string, std::string> &cppTypenameToSipTypename =
    getTypenamesMap();
...
void *convertSipWrapperToCppType(PyObject *sipWrapper,
  ...
  if (kTypeDef &&
      sipCanConvertToType(pyObject, kTypeDef, transferTo ? 0 : SIP_NOT_NONE)) {
    int state = 0, err = 0;

    if (!transferTo) {
      return sipConvertToType(pyObject, kTypeDef, Py_None, SIP_NOT_NONE, &state,
                              &err);
    } else {
  ...
  } else if (cppTypenameToSipTypename.find(cppTypename) !=
             cppTypenameToSipTypename.end()) {
    kTypeDef = sipFindType(cppTypenameToSipTypename[cppTypename].c_str());

    if (kTypeDef && sipCanConvertToType(pyObject, kTypeDef,
                                        transferTo ? 0 : SIP_NOT_NONE)) {
      int state = 0, err = 0;

      if (!transferTo) {
        return sipConvertToType(pyObject, kTypeDef, Py_None, SIP_NOT_NONE,
                                &state, &err);
      } else {
        void *p =
            sipConvertToType(pyObject, kTypeDef, nullptr, 0, &state, &err);
        sipTransferTo(pyObject, pyObject);
        return p;
      }
    }
...
PyObject *convertCppTypeToSipWrapper(void *cppObj,
                                     const std::string &cppTypename,
                                     bool fromNew) {
  const sipTypeDef *kTypeDef = sipFindType(cppTypename.c_str());
...
#define CHECK_BASE_CPP_TYPE_CONVERSION(T)                                      \
  if (!pyObj && dataType &&                                                    \
      dataType->getTypeName() == std::string(typeid(T).name())) {              \
...
#define CHECK_SIP_TYPE_CONVERSION(CPP_TYPE, SIP_TYPE_STR)                      \
  if (sipCanConvertToType(pyObj, sipFindType(SIP_TYPE_STR), SIP_NOT_NONE)) {   \
    if (!dataType ||                                                           \
        dataType->getTypeName() == std::string(typeid(CPP_TYPE).name())) {     \
...
#define CHECK_SIP_VECTOR_LIST_CONVERSION(CPP_TYPE, SIP_TYPE_STR)               \
  if (sipCanConvertToType(                                                     \
          pyObj,                                                               \
          sipFindType(                                                         \
              (std::string("std::vector<") + SIP_TYPE_STR + ">").c_str()),     \
          SIP_NOT_NONE)) {                                                     \
    if (dataType && dataType->getTypeName() ==                                 \
                        std::string(typeid(std::list<CPP_TYPE>).name())) {     \
      valSetter.setValue(                                                      \
          getCppObjectFromPyObject<std::list<CPP_TYPE>>(pyObj));               \
    } else {                                                                   \
      valSetter.setValue(                                                      \
          getCppObjectFromPyObject<std::vector<CPP_TYPE>>(pyObj));             \
    }                                                                          \
    return true;                                                               \
  }

bool setCppValueFromPyObject(PyObject *pyObj, ValueSetter &valSetter,
                             tlp::DataType *dataType) {
  ...
  if (PyLong_Check(pyObj)) {
    ...
    if (dataType &&
        dataType->getTypeName() == std::string(typeid(int).name())) {
      valSetter.setValue(int(val));
    } else if (dataType && dataType->getTypeName() ==
                               std::string(typeid(unsigned int).name())) {
      valSetter.setValue(getCppObjectFromPyObject<unsigned int>(pyObj));
    } else if (dataType &&
               dataType->getTypeName() == std::string(typeid(long).name())) {
      ...
      valSetter.setValue(getCppObjectFromPyObject<unsigned long>(pyObj));
               ...
               dataType->getTypeName() == std::string(typeid(float).name())) {
      valSetter.setValue(float(val));
    } else if (dataType &&
               dataType->getTypeName() == std::string(typeid(double).name())) {
  ...
  if (sipCanConvertToType(pyObj, sipFindType("std::vector<long>"),
                          SIP_NOT_NONE)) {
    if (dataType && dataType->getTypeName() ==
                        std::string(typeid(std::vector<int>).name())) {
      valSetter.setValue(getCppObjectFromPyObject<std::vector<int>>(pyObj));
    } else if (dataType &&
               dataType->getTypeName() ==
                   std::string(typeid(std::vector<unsigned int>).name())) {
      valSetter.setValue(
          getCppObjectFromPyObject<std::vector<unsigned int>>(pyObj));
    } else if (dataType && dataType->getTypeName() ==
                               std::string(typeid(std::vector<long>).name())) {
      valSetter.setValue(getCppObjectFromPyObject<std::vector<long>>(pyObj));
    } else if (dataType &&
               dataType->getTypeName() ==
                   std::string(typeid(std::vector<unsigned long>).name())) {
      valSetter.setValue(
          getCppObjectFromPyObject<std::vector<unsigned long>>(pyObj));
    } else if (dataType && dataType->getTypeName() ==
                               std::string(typeid(std::vector<float>).name())) {
      valSetter.setValue(getCppObjectFromPyObject<std::vector<float>>(pyObj));
    } else if (dataType &&
               dataType->getTypeName() ==
                   std::string(typeid(std::vector<double>).name())) {
      valSetter.setValue(getCppObjectFromPyObject<std::vector<double>>(pyObj));

    } else if (dataType && dataType->getTypeName() ==
                               std::string(typeid(std::list<int>).name())) {
      valSetter.setValue(getCppObjectFromPyObject<std::list<int>>(pyObj));
    } else if (dataType &&
               dataType->getTypeName() ==
                   std::string(typeid(std::list<unsigned int>).name())) {
      valSetter.setValue(
          getCppObjectFromPyObject<std::list<unsigned int>>(pyObj));
    } else if (dataType && dataType->getTypeName() ==
                               std::string(typeid(std::list<long>).name())) {
      valSetter.setValue(getCppObjectFromPyObject<std::list<long>>(pyObj));
    } else if (dataType &&
               dataType->getTypeName() ==
                   std::string(typeid(std::list<unsigned long>).name())) {
      valSetter.setValue(
          getCppObjectFromPyObject<std::list<unsigned long>>(pyObj));
    } else if (dataType && dataType->getTypeName() ==
                               std::string(typeid(std::list<float>).name())) {
      valSetter.setValue(getCppObjectFromPyObject<std::list<float>>(pyObj));
    } else if (dataType && dataType->getTypeName() ==
                               std::string(typeid(std::list<double>).name())) {
  ...
  if (sipCanConvertToType(pyObj, sipFindType("std::vector<double>"),
                          SIP_NOT_NONE)) {
    if (dataType && dataType->getTypeName() ==
                        std::string(typeid(std::vector<float>).name())) {
      valSetter.setValue(getCppObjectFromPyObject<std::vector<float>>(pyObj));
  ...
  if (sipCanConvertToType(pyObj, sipFindType("std::set<long>"), SIP_NOT_NONE)) {
    if (dataType &&
        dataType->getTypeName() == std::string(typeid(std::set<int>).name())) {
      valSetter.setValue(getCppObjectFromPyObject<std::set<int>>(pyObj));
    } else if (dataType &&
               dataType->getTypeName() ==
                   std::string(typeid(std::set<unsigned int>).name())) {
      valSetter.setValue(
          getCppObjectFromPyObject<std::set<unsigned int>>(pyObj));
    } else if (dataType && dataType->getTypeName() ==
                               std::string(typeid(std::set<long>).name())) {
      valSetter.setValue(getCppObjectFromPyObject<std::set<long>>(pyObj));
    } else if (dataType &&
               dataType->getTypeName() ==
                   std::string(typeid(std::set<unsigned long>).name())) {
      valSetter.setValue(
          getCppObjectFromPyObject<std::set<unsigned long>>(pyObj));
    } else if (dataType && dataType->getTypeName() ==
                               std::string(typeid(std::set<float>).name())) {
      valSetter.setValue(getCppObjectFromPyObject<std::set<float>>(pyObj));
    } else if (dataType && dataType->getTypeName() ==
                               std::string(typeid(std::set<double>).name())) {
  ...
  if (sipCanConvertToType(pyObj, sipFindType("std::set<double>"),
                          SIP_NOT_NONE)) {
    if (dataType && dataType->getTypeName() ==
                        std::string(typeid(std::set<float>).name())) {
      valSetter.setValue(getCppObjectFromPyObject<std::set<float>>(pyObj));
  ...
  CHECK_SIP_POINTER_TYPE_CONVERSION(tlp::BooleanProperty,
                                    "tlp::BooleanProperty")
  ...
  CHECK_SIP_POINTER_TYPE_CONVERSION(tlp::IntegerProperty,
                                    "tlp::IntegerProperty")
  CHECK_SIP_POINTER_TYPE_CONVERSION(tlp::NumericProperty,
                                    "tlp::NumericProperty")
  ...
  CHECK_SIP_POINTER_TYPE_CONVERSION(tlp::BooleanVectorProperty,
                                    "tlp::BooleanVectorProperty")
  CHECK_SIP_POINTER_TYPE_CONVERSION(tlp::ColorVectorProperty,
                                    "tlp::ColorVectorProperty")
  CHECK_SIP_POINTER_TYPE_CONVERSION(tlp::DoubleVectorProperty,
                                    "tlp::DoubleVectorProperty")
  CHECK_SIP_POINTER_TYPE_CONVERSION(tlp::IntegerVectorProperty,
                                    "tlp::IntegerVectorProperty")
  CHECK_SIP_POINTER_TYPE_CONVERSION(tlp::CoordVectorProperty,
                                    "tlp::CoordVectorProperty")
  CHECK_SIP_POINTER_TYPE_CONVERSION(tlp::SizeVectorProperty,
                                    "tlp::SizeVectorProperty")
  CHECK_SIP_POINTER_TYPE_CONVERSION(tlp::StringVectorProperty,
                                    "tlp::StringVectorProperty")
  CHECK_SIP_POINTER_TYPE_CONVERSION(tlp::PropertyInterface,
  ...
  CHECK_SIP_VECTOR_LIST_CONVERSION(tlp::StringCollection,
                                   "tlp::StringCollection")
  CHECK_SIP_VECTOR_LIST_CONVERSION(tlp::BooleanProperty *,
                                   "tlp::BooleanProperty*")
  CHECK_SIP_VECTOR_LIST_CONVERSION(tlp::ColorProperty *, "tlp::ColorProperty*")
  CHECK_SIP_VECTOR_LIST_CONVERSION(tlp::DoubleProperty *,
                                   "tlp::DoubleProperty*")
  CHECK_SIP_VECTOR_LIST_CONVERSION(tlp::IntegerProperty *,
                                   "tlp::IntegerProperty*")
  CHECK_SIP_VECTOR_LIST_CONVERSION(tlp::LayoutProperty *,
                                   "tlp::LayoutProperty*")
  CHECK_SIP_VECTOR_LIST_CONVERSION(tlp::SizeProperty *, "tlp::SizeProperty*")
  CHECK_SIP_VECTOR_LIST_CONVERSION(tlp::StringProperty *,
                                   "tlp::StringProperty*")
  CHECK_SIP_VECTOR_LIST_CONVERSION(tlp::PropertyInterface *,
                                   "tlp::PropertyInterface*")
