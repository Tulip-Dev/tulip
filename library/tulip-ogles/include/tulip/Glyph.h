...
std::string nodeGlyphName() const { return NODE_GLYPH_NAME; }\
std::string edgeExtremityGlyphName() const { return EDGE_EXTREMITY_GLYPH_NAME; }\
bool edgeExtremityGlyph() const { return !std::string(EDGE_EXTREMITY_GLYPH_NAME).empty(); }
