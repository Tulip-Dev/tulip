...
TextureData *tlp::loadTextureData(const char *file) {
  tlp_stat_t buf;
  if (tlp::statPath(file, &buf) < 0) return nullptr;
  int w,h,n;
...
//===========================================================================================================
Coord tlp::projectPoint(const Coord &obj,
...
//===========================================================================================================
Coord tlp::unprojectPoint(const Coord &obj,
...
float tlp::calculateAABBSize(const BoundingBox &bb,const Coord &eye, const MatrixGL &transformMatrix,
...
//===========================================================================================================
GLfloat tlp::projectSize(const Coord &position,const Size& size,
...
//===========================================================================================================
GLfloat tlp::projectSize(const BoundingBox &bb,
                    const MatrixGL &projectionMatrix, const MatrixGL &modelviewMatrix,
                    const Vec4i &viewport) {
