...
MACRO(PREPARE_DEB basename deps)
  ...
  IF(NOT EXISTS "${BUILD_DIR}/${${TMP}_PACKAGE}.deb")
    ...
    SET(CPACK_DEBIAN_PACKAGE_DESCRIPTION_SUMMARY "${CPACK_COMPONENT_${TMP}_DISPLAY_NAME}")
    SET(CPACK_DEBIAN_PACKAGE_DESCRIPTION "${CPACK_COMPONENT_${TMP}_DISPLAY_NAME}.\n ${CPACK_COMPONENT_${TMP}_DESCRIPTION}")
