...
public:
  PLUGININFORMATION("Planar", "Tulip team", "18/04/2012",
                    "Tests whether a graph is planar or not.", "1.0",
                    "Topological Test")
  PlanarityTest(const tlp::PluginContext *context) : tlp::GraphTest(context) {}

  bool test() override { return tlp::PlanarityTest::isPlanar(graph); }
};
...
public:
  ...
  PlanarEmbeddingTest(const tlp::PluginContext *context)
      : tlp::GraphTest(context) {}

  bool test() override { return tlp::PlanarityTest::isPlanarEmbedding(graph); }
};
...
public:
  PLUGININFORMATION("Make Planar Embedding", "Tulip team", "18/04/2012",
                    ...
                    "1.0", "Topology Update")
  MakePlanarEmbedding(const tlp::PluginContext *context)
      : tlp::Algorithm(context) {}

  bool run() override { return tlp::PlanarityTest::planarEmbedding(graph); }
