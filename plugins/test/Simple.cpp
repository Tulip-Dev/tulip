...
public:
  PLUGININFORMATION("Simple", "Tulip team", "18/04/2012",
                    "Test whether a graph is simple or not.<br/>A simple graph is an undirected graph with no loops and no multiple edges.", "1.0",
                    "Topological Test")
...
public:
  PLUGININFORMATION("Make Simple", "Tulip team", "18/04/2012",
                    "Make a graph simple.<br/>A simple graph is an undirected graph with no loops and no multiple edges.", "1.0", "Topology Update")
