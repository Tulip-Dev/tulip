...
public:
  ...
  InteractorRectangleZoom(const tlp::PluginContext *) : NodeLinkDiagramComponentInteractor(getInteractorIcon(), "Zoom on rectangle") {
    ...
    setConfigurationWidgetText(QString("<h3>Zoom on rectangle</h3>") + "Zoom on selected rectangle.<br><b>Mouse left</b> down indicates the first "
                                                                       "corner.<br> <b>Mouse left</b> up indicates the opposite corner.<br> <b>Mouse "
                                                                       "left Doucle click</b> to center the view.");
  }
