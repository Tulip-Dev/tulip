/*
	  NeighbourhoodHighlighterInteractor.cpp
...
public :
	...
	void setDrawLabelMode(const bool drawLabel) {drawLabelMode = drawLabel;}
...
void NeighborhoodHighlighter::computeNeighborhoodGraphCircleLayout() {
	...
	edge e;
	forEach(e, neighborhoodGraph->getEdges()) {
		node srcNode = neighborhoodGraph->source(e);
		node tgtNode = neighborhoodGraph->target(e);
