...
public:
   ...
   * Default constructor
   */
  InteractorSelection(const tlp::PluginContext*):NodeLinkDiagramComponentInteractor(FontIconManager::instance()->getMaterialDesignIcon(md::selection, Qt::white),"Select nodes/edges in a rectangle") {
