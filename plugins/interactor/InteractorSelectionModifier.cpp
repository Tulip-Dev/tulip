...
public:
  ...
  InteractorSelectionModifier(const tlp::PluginContext *)
      : NodeLinkDiagramComponentInteractor(":/tulip/gui/icons/i_move.png", "Move/Reshape rectangle selection") {
    setPriority(StandardInteractorPriority::RectangleSelectionModifier);
    setConfigurationWidgetText(QString("<h3>Move/Reshape rectangle selection</h3>") + "Modify selection<br/><br/>" +
