...
public:
   ...
   * Default constructor
   */
  InteractorAddEdge(const tlp::PluginContext*):NodeLinkDiagramComponentInteractor(FontIconManager::instance()->getMaterialDesignIcon(md::vectorpolyline, Qt::white),"Add nodes/edges") {
