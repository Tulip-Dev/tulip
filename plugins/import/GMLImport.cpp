...
public:
  PLUGININFORMATION("GML","Auber","04/07/2001",
                    "<p>Supported extension: gml</p><p>Imports a new graph from a file (.gml) in the GML input format (used by Graphlet).<br/>See <b>www.infosun.fmi.uni-passau.de/Graphlet/GML/</b> for details.</p>",
                    "1.1","File")
