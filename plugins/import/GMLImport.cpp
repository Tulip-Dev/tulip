...
struct GMLNodeGraphicsBuilder : public GMLTrue {
  ...
  GMLNodeGraphicsBuilder(GMLNodeBuilder *nodeBuilder)
      : nodeBuilder(nodeBuilder), coord(Coord(0, 0, 0)), size(Size(1, 1, 1)), color(Color(0, 0, 0, 255)) {
  }
...
struct GMLEdgeBuilder : public GMLTrue {
  ...
  GMLEdgeBuilder(GMLGraphBuilder *graphBuilder) : graphBuilder(graphBuilder), source(-1), target(-1), edgeOk(false) {
  }
  bool addInt(const string &st, const int id) {
    bool result = true;
...
struct GMLEdgeGraphicsBuilder : public GMLTrue {
  ...
  GMLEdgeGraphicsBuilder(GMLEdgeBuilder *edgeBuilder) : edgeBuilder(edgeBuilder), size(Size(0, 0, 0)), color(Color(0, 0, 0, 0)) {
  }
...
struct GMLEdgeGraphicsLineBuilder : public GMLTrue {
  ...
  GMLEdgeGraphicsLineBuilder(GMLEdgeGraphicsBuilder *edgeGraphicsBuilder) : edgeGraphicsBuilder(edgeGraphicsBuilder) {
  }
...
public:
  PLUGININFORMATION("GML", "Auber", "04/07/2001", "Imports a new graph from a file (.gml) in the GML input format (used by Graphlet).<br/>See "
                                                  "<b>www.infosun.fmi.uni-passau.de/Graphlet/GML/</b> for details.",
                    "1.1", "File")
