...
public:
  ...
  FileSystem(tlp::PluginContext* context):ImportModule(context), _absolutePaths(nullptr), _baseNames(nullptr), _createdDates(nullptr),
    _fileNames(nullptr), _isDir(nullptr), _isExecutable(nullptr), _isReadable(nullptr), _isSymlink(nullptr), _isWritable(nullptr), _lastModifiedDates(nullptr),
    _lastReadDates(nullptr), _owners(nullptr), _permissions(nullptr), _suffixes(nullptr), _sizes(nullptr), _fontAwesomeIcon(nullptr), _useIcons(true), _treeLayout(true), dirColor(255, 255, 127, 128) {
