 ...
 * Assortative model for social networks. Physical Review E (Statistical, Nonlinear, and Soft Matter Physics), 70(3), (2004).
 *
 */
struct Catanzaro:public ImportModule {
  PLUGININFORMATION("Catanzaro and al. Model", "Arnaud Sallaberry","21/02/2011","Randomly generates a graph using the model described in<br/>Michele Catanzaro, Guido Caldarelli, and Luciano Pietronero.<br/><b>Assortative model for social networks.</b><br/>Physical Review E (Statistical, Nonlinear, and Soft Matter Physics), 70(3), (2004).","1.0","Social network")
