...
struct BollobasModel : public ImportModule {
  PLUGININFORMATION("Bollobas et al. Model", "Arnaud Sallaberry", "21/02/2011",
                    "Randomly generates a scale-free graph using the model described in<br/>B. Bollobas, O.M Riordan, J. Spencer and G. "
                    "Tusnady.<br/><b>The Degree Sequence of a Scale-Free Random Graph Process.</b><br/>RSA: Random Structures & Algorithms, 18, 279 "
                    "(2001)",
                    "1.1", "Social network")
