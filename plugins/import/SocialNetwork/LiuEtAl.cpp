...
struct LiuEtAl : public ImportModule {
  PLUGININFORMATION("Liu et al. model", "Arnaud Sallaberry", "20/06/2011", "Randomly generates a small world graph using the model described "
                                                                           "in<br/>J.-G. Liu, Y.-Z. Dang, and Z. tuo Wang.<br/><b>Multistage random "
                                                                           "growing small-world networks with power-law degree "
                                                                           "distribution.</b><br/>Chinese Phys. Lett., 23(3):746, Oct. 31 2005.",
                    "1.0", "Social network")
