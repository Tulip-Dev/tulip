...
static const char *paramHelp[] = {
    ...
    // alpha
    "This parameter defines the alpha parameter between [0,1]. This one is a percentage and describes the distribution of attractiveness; the model "
    "suggests about 1 - alpha of the individuals have very low attractiveness whereas the remaining alpha are approximately evenly distributed "
    "between low, medium, and high attractiveness",

    // beta
    "This parameter defines the beta parameter between [0,1]. This parameter indicates the probability a person will have the desire to introduce "
    "someone."};
...
public:
  PLUGININFORMATION("Attract And Introduce Model", "Arnaud Sallabery & Patrick Mary", "25/03/2014",
                    "Randomly generates a graph using the Attract and Introduce Model described in<br/>J. H. Fowlera, C. T. Dawesa, N. A. "
                    "Christakisb.<br/><b>Model of genetic variation in human social networks.</b><br/>PNAS 106 (6): 1720-1724, 2009.",
                    "1.0", "Social network")
