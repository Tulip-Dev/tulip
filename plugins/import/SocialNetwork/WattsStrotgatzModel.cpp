...
struct WattsStrotgatzModel : public ImportModule {
  PLUGININFORMATION("Watts Strotgatz Model", "Arnaud Sallaberry", "21/02/2011", "Randomly generates a small world graph using the model described "
                                                                                "in<br/>D. J. Watts and S. H. Strogatz.<br/><b>Collective dynamics "
                                                                                "of small-world networks.</b><br/>Nature 393, 440 (1998).",
                    "1.0", "Social network")
