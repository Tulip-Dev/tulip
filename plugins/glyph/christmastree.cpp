...
//===================================================================================
ChristmasTree::ChristmasTree(GlyphContext *gc): Glyph(gc) {
}
//=======================================================
void
ChristmasTree::draw(node n,float lod) {
  if(GlDisplayListManager::getInst().beginNewDisplayList("ChristmasTree_tree")) {
  ...
  if(GlDisplayListManager::getInst().beginNewDisplayList("ChristmasTree_sphere")) {
  ...
  if(GlDisplayListManager::getInst().beginNewDisplayList("ChristmasTree_outsphere")) {
    GLUquadricObj *quadratic = gluNewQuadric();
    gluQuadricNormals(quadratic, GLU_SMOOTH);
    gluQuadricTexture(quadratic, GL_TRUE);
