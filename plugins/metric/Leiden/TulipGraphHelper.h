...
{
  public:
    Graph(tlp::VectorGraph* graph,
          vector<double> const& edge_weights,
          vector<double> const& node_sizes,
          bool correct_self_loops, bool is_directed);
    Graph(tlp::Graph* graph, tlp::NumericProperty *edge_weights,
          bool is_directed);
    ~Graph();
    ...
    inline size_t vcount() { return _graph->numberOfNodes(); }
    inline size_t ecount() { return _graph->numberOfNodes(); }
    inline double total_weight() { return this->_total_weight; };
    inline double total_size() { return this->_total_size; };
    inline bool is_directed() { return this->_is_directed; };
    inline double density() { return this->_density; };
    inline bool correct_self_loops() { return this->_correct_self_loops; };
    inline bool is_weighted() { return this->_is_weighted; };
