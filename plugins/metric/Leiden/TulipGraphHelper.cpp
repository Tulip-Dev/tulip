...
Graph::Graph(tlp::VectorGraph* graph,
...
Graph::Graph(tlp::Graph* graph, tlp::NumericProperty *edge_weights,
             bool is_directed)
{
...
Graph* Graph::collapse_graph(MutableVertexPartition* partition)
{
  ...
  Graph* G = new Graph(n_graph, collapsed_weights, csizes, this->_correct_self_loops, this->_is_directed);
  return G;
}
