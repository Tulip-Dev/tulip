...
public:
  PLUGININFORMATION("Strength", "David Auber", "26/02/2003", "Computes the Strength metric described in<br/><b>Software component capture using "
                                                             "graph clustering</b>, Y. Chiricota. F.Jourdan, an G.Melancon, IWPC (2002).",
                    "1.0", "Graph")
