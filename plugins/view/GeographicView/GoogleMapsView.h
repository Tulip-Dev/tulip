 ...
 * This view plugin allows to visualize a geolocalized Tulip graph on top of Google Maps.
...
public :
  ...
  QGraphicsView *graphicsView() const {return googleMapsGraphicsView;}
...
public slots :
  ...
  void graphChanged(Graph *) {setState(DataSet());}
