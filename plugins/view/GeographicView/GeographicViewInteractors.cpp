...
bool GeographicViewNavigator::eventFilter(QObject *widget, QEvent *e) {
  ...
  if (geoView->viewType() == GeographicView::GoogleRoadMap || geoView->viewType() == GeographicView::GoogleSatellite ||
      geoView->viewType() == GeographicView::GoogleTerrain || geoView->viewType() == GeographicView::GoogleHybrid) {
