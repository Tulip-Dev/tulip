 ...
 */
  ...
  public :
    ...
    PLUGININFORMATIONS(ParallelCoordinatesView::viewName, "Antoine Lambert", "16/04/2008",
    ...
    void resetAxisLayoutNextUpdate() {parallelCoordsDrawing->resetAxisLayoutNextUpdate();}
