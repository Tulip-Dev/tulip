...
ParallelCoordinatesInteractor::ParallelCoordinatesInteractor(const QString &iconPath, const QString &text):GLInteractorComposite(QIcon(iconPath),text){}
...
QString interactorAxisSpacerHelpText =
"<html>"
"<head>"
"<title></title>"
"</head>"
...
QWidget *InteractorParallelCoordsSelection::configurationWidget() const {
  QLabel *_label = new QLabel(interactorParallelCoordsSelectionHelpText);
...
QWidget *InteractorHighLighter::configurationWidget() const {
  QLabel *_label = new QLabel(interactorParallelCoordsHighlighterHelpText);
  _label->setWordWrap(true);
  _label->setAlignment(Qt::AlignTop);
  _label->setSizePolicy(QSizePolicy::Expanding,QSizePolicy::Expanding);
  return _label;
...
QWidget *InteractorAxisSwapper::configurationWidget() const {
  QLabel *_label = new QLabel(interactorAxisSwapperHelpText);
  _label->setWordWrap(true);
  _label->setAlignment(Qt::AlignTop);
  _label->setSizePolicy(QSizePolicy::Expanding,QSizePolicy::Expanding);
  return _label;
...
QWidget *InteractorAxisSliders::configurationWidget() const {
  QLabel *_label = new QLabel(interactorAxisSlidersHelpText);
  _label->setWordWrap(true);
  _label->setAlignment(Qt::AlignTop);
  _label->setSizePolicy(QSizePolicy::Expanding,QSizePolicy::Expanding);
  return _label;
...
QWidget *InteractorBoxPlot::configurationWidget() const {
  QLabel *_label = new QLabel(interactorParallelBoxPlotHelpText);
  _label->setWordWrap(true);
  _label->setAlignment(Qt::AlignTop);
  _label->setSizePolicy(QSizePolicy::Expanding,QSizePolicy::Expanding);
  return _label;
...
QWidget *InteractorShowElementInfos::configurationWidget() const {
  QLabel *_label = new QLabel(interactorParallelEltShowInfosHelpText);
  _label->setWordWrap(true);
  _label->setAlignment(Qt::AlignTop);
  _label->setSizePolicy(QSizePolicy::Expanding,QSizePolicy::Expanding);
  return _label;
...
QWidget *InteractorAxisSpacer::configurationWidget() const {
  QLabel *_label = new QLabel(interactorAxisSpacerHelpText);
  _label->setWordWrap(true);
  _label->setAlignment(Qt::AlignTop);
  _label->setSizePolicy(QSizePolicy::Expanding,QSizePolicy::Expanding);
  return _label;
