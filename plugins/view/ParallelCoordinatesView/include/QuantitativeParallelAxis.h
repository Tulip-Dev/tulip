...
public:
  ...
  void setBoxPlotHighlightBounds(BoxPlotValue lowBound,
                                 BoxPlotValue highBound) {
...
private:
  const std::set<unsigned int> &getDataInRange(float yLowBound,
                                               float yHighBound);
