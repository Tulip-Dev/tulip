...
ScatterPlotQuickAccessBar::ScatterPlotQuickAccessBar(ScatterPlot2DOptionsWidget* opt, QWidget *parent):
...
void ScatterPlotQuickAccessBar::reset() {
  ...
  showLabelScaled()->setIcon((_optionsWidget->displayScaleLabels() ? QIcon(":/tulip/gui/icons/20/labels_scaled_enabled.png") : QIcon(":/tulip/gui/icons/20/labels_scaled_disabled.png")));
...
void ScatterPlotQuickAccessBar::setLabelsScaled(bool scaled) {
  ...
  showLabelScaled()->setIcon((scaled ? QIcon(":/tulip/gui/icons/20/labels_scaled_enabled.png") : QIcon(":/tulip/gui/icons/20/labels_scaled_disabled.png")));
  emit settingsChanged();
}
