...
public :
	...
	void setImageSize(unsigned int width, unsigned int height) {imageSize[0] = width ; imageSize[1] = height;}
	...
	void setCenterItem(const unsigned int centerItem) {this->centerItem = centerItem;}
