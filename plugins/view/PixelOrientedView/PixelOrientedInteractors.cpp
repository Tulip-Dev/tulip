...
PixelOrientedInteractorNavigation::PixelOrientedInteractorNavigation(const PluginContext *)
  ...
  setConfigurationWidgetText(QString("<html><head>") + "<title></title>" + "</head>" + "<body>" + "<h3>View navigation interactor</h3>" +
                             ...
                             "<p>When there is more than one graph properties selected, the corresponding pixel oriented previews are generated and "
                             "displayed in a matrix form. By <b>double clicking on a pixel oriented preview, " +
                             "this one is displayed in fullscreen </b> in a more detailed way and the others interactors become available. To go "
                             "back to the pixel oriented previews matrix, double click anywhere in the view.</p>" +
