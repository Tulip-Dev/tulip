...
QVariant GraphTableModel::data(const QModelIndex& index, int role ) const {
    ...
    case Qt::EditRole:
        ...
        if(tableIndex.isValid() && _propertiesToDelete.find(tableIndex.property())==_propertiesToDelete.end()) {
            ...
            //            PropertyInterface* property= tableIndex.property();

            //            if (property->getTypename() == BooleanProperty::propertyTypename) {
            //                return createQVariantFromTulipProperty<BooleanProperty,bool,bool>(_elementType,tableIndex.element(),static_cast<BooleanProperty*>(property));
            //            }
            //            else if (property->getTypename() == ColorProperty::propertyTypename) {
            //                return createQVariantFromTulipProperty<ColorProperty,tlp::Color,tlp::Color>(_elementType,tableIndex.element(),static_cast<ColorProperty*>(property));
            //            }
            //            else if (property->getTypename() == DoubleProperty::propertyTypename) {
            //                return createQVariantFromTulipProperty<DoubleProperty,double,double>(_elementType,tableIndex.element(),static_cast<DoubleProperty*>(property));
            //            }
            //            else if (property->getTypename() == IntegerProperty::propertyTypename) {
            ...
            //                }else{
            //                    return createQVariantFromTulipProperty<IntegerProperty,int,int>(_elementType,tableIndex.element(),static_cast<IntegerProperty*>(property));
            //                }
            //            }
            //            else if (property->getTypename() == SizeProperty::propertyTypename) {
            //                if(property->getName().compare("viewSrcAnchorSize")==0 ) {
            //                }
            ...
            //                }
            //            }
            //            else if (property->getTypename() == LayoutProperty::propertyTypename) {
            //            }
            //            else if(property->getTypename() == StringProperty::propertyTypename) {
            ...
            //                }
            //            }
            //            else if (property->getTypename() == StringVectorProperty::propertyTypename) {
            //            }
            //            else if (property->getTypename() == ColorVectorProperty::propertyTypename) {
            //            }
            //            else if (property->getTypename() == SizeVectorProperty::propertyTypename) {
            //            }
            //            else if (property->getTypename() == BooleanVectorProperty::propertyTypename) {
            //            }
            //            else if (property->getTypename() == DoubleVectorProperty::propertyTypename) {
            //            }
            //            else if (property->getTypename() == IntegerVectorProperty::propertyTypename) {
            //            }
            //            else if (property->getTypename() == CoordVectorProperty::propertyTypename) {
            //            }
        }
    }
    return QVariant();
