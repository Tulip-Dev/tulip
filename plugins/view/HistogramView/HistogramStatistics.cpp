...
: histoView(NULL) , histoStatsConfigWidget(NULL),
...
void HistogramStatistics::setConfigWidget(HistoStatsConfigWidget *histoStatsConfigWidget) {
	this->histoStatsConfigWidget = histoStatsConfigWidget;
}
