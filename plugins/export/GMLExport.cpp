...
public:
  PLUGININFORMATION("GML Export","Auber David","31/07/2001","Export a Tulip graph in a file using the GML format (used by Graphlet).<br/>See <b>www.infosun.fmi.uni-passau.de/Graphlet/GML/</b> for details.","1.0", "File")
