...
public:
  ...
  PLUGININFORMATION("CSV Export", "David Auber, Patrick Mary","18/01/2011","Exports the values of tulip graph properties associated to graph elements in a CSV file.","1.0","File")
