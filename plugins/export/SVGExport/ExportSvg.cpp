...
bool ExportSvg::addLabel(const string &type, const string &label,
  ...
  if (!label.empty()) {
    ...
    if (type == "node")
      _res.writeAttribute(
          "font-size", QString::number((size.getW() * 1.2) / label.length()));
    else if (type == "edge")
      _res.writeAttribute(
          "font-size",
          QString::number(((size.getW() + size.getH()) / label.length()) + 8));
...
bool ExportSvg::createEdge(
  ...
  if (bends.empty()) { // If there is no checkpoints, it will be a simple line
    ...
    case EdgeShape::Polyline: {
      points += " L";
      for (vector<Coord>::const_iterator it = bends.begin(); it != bends.end();
           ++it) {
...
bool ExportSvg::exportEdgeExtremity(
    ...
    const tlp::EdgeExtremityShape::EdgeExtremityShapes src_anchor_shape_type,
    const tlp::EdgeExtremityShape::EdgeExtremityShapes tgt_anchor_shape_type,
    const tlp::Color &color, unsigned int &id_src_gradient,
    unsigned int &id_tgt_gradient, const Coord &coord_edge_extremity_source,
  ...
  if (src_anchor_shape_type != EdgeExtremityShape::None) {
    ...
    case EdgeExtremityShape::Star: {
      ...
      _res.writeAttribute(
          "points",
          "6,0 3.75,3 0,2 2.25,5 0,8 3.75,6.9 6,10 6,6.25 10,5 6,3.75");
      _res.writeAttribute("fill", tlpColor2SvgColor(color));
      break;
    }
    ...
    case EdgeExtremityShape::Cone: {
      ...
      _res.writeAttribute("refY", "5");
      _res.writeStartElement("polygon");
      _res.writeAttribute("points", "0,5 0.94,8 3.44,10 6.94,10 9.88,8.15 "
                                    "10.94,5 9.88,2 6.94,0 3.44,0 0.94,2");
      _res.writeAttribute("fill", tlpColor2SvgColor(color));
      break;
    }
    ...
    case EdgeExtremityShape::Sphere: {
      ...
      QString milieu_gradient_sphere =
          "RadGradientSrc" % QString::number(id_src_gradient);
      QString fin_gradient_sphere = ")";
      QString gradient_sphere =
          debut_gradient_sphere % milieu_gradient_sphere % fin_gradient_sphere;
    ...
    case EdgeExtremityShape::GlowSphere: {
      ...
      QString milieu_glow_sphere =
          "RadGradientSrc" % QString::number(id_src_gradient + 1);
      QString fin_glow_sphere = ")";
      QString glow_sphere =
          debut_glow_sphere % milieu_glow_sphere % fin_glow_sphere;
      ...
      _res.writeStartElement("ellipse");
      _res.writeAttribute("cx",
                          QString::number(coord_edge_extremity_source.getX()));
      _res.writeAttribute("cy",
                          QString::number(coord_edge_extremity_source.getY()));
      ...
      _res.writeAttribute("cy",
                          QString::number(coord_edge_extremity_source.getY()));
      _res.writeAttribute("rx", QString::number(size_node_src.getW() / 2 -
                                                size_node_src.getW() / 8));
      _res.writeAttribute("ry", QString::number(size_node_src.getH() / 2 -
                                                size_node_src.getH() / 8));
      _res.writeAttribute("fill", "white");
  ...
  if (tgt_anchor_shape_type != EdgeExtremityShape::None) {
    ...
    case EdgeExtremityShape::Sphere: {
      QString debut_gradient_sphere = "url(#";
      QString milieu_gradient_sphere =
          "RadGradientTgt" % QString::number(id_tgt_gradient);
      QString fin_gradient_sphere = ")";
      QString gradient_sphere =
          debut_gradient_sphere % milieu_gradient_sphere % fin_gradient_sphere;
    ...
    case EdgeExtremityShape::GlowSphere: {
      ...
      QString debut_glow_sphere = "url(#";
      QString milieu_glow_sphere =
          "RadGradientTgt" % QString::number(id_tgt_gradient + 1);
      QString fin_glow_sphere = ")";
      QString glow_sphere =
          debut_glow_sphere % milieu_glow_sphere % fin_glow_sphere;
      ...
      _res.writeStartElement("ellipse");
      _res.writeAttribute("cx",
                          QString::number(coord_edge_extremity_target.getX()));
      _res.writeAttribute("cy",
                          QString::number(coord_edge_extremity_target.getY()));
      ...
      _res.writeAttribute("cy",
                          QString::number(coord_edge_extremity_target.getY()));
      _res.writeAttribute("rx", QString::number(size_node_tgt.getW() / 2 -
                                                size_node_tgt.getW() / 8));
      _res.writeAttribute("ry", QString::number(size_node_tgt.getH() / 2 -
                                                size_node_tgt.getH() / 8));
      _res.writeAttribute("fill", "white");
      _res.writeAttribute("fill-opacity", "0");
      break;
    }
