...
#pragma omp critical(DIKCREATE)
  ...
  void initDijkstra(const tlp::Graph *const forbiddenNodes, tlp::node src, const tlp::MutableContainer<double> &weights,
