...
public:
  PLUGININFORMATION("Dendrogram", "Julien Testut, Antony Durand, Pascal Ollier, Yashvin Nababsing, Sebastien Leclerc, Thibault Ruchon, Eric Dauchier",
                    "03/12/04", "This is an implementation of a dendrogram, an extended implementation of a <b>Bio representation</b> which includes "
...
private:
  ...
  float setAllNodesCoordX(tlp::node n, float rightMargin, OrientableLayout *oriLayout, OrientableSizeProxy *oriSize);
  ...
  void setCoordY(tlp::node n, float &maxYLeaf, OrientableLayout *oriLayout, OrientableSizeProxy *oriSize);
  void computeLevelHeights(tlp::Graph *tree, tlp::node n, unsigned int depth, OrientableSizeProxy *oriSize);
};
