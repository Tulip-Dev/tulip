...
public:
  PLUGININFORMATION("Dendrogram", "Julien Testut, Antony Durand, Pascal Ollier, Yashvin Nababsing, "
                                  "Sebastien Leclerc, Thibault Ruchon, Eric Dauchier",
                    "03/12/04", "This is an implementation of a dendrogram, an extended "
