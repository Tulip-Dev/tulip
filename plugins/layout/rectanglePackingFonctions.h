 ...
 */
std::vector<tlp::Rectangle<float>> &RectanglePackingLimitRectangles(std::vector<tlp::Rectangle<float>> &v, const char *quality,
 ...
 *@return the vector v whose rectangles have had their co-ordinates changed.
 */
std::vector<tlp::Rectangle<float>> &RectanglePackingLimitPositions(std::vector<tlp::Rectangle<float>> &v, const char *quality,
                                                                   tlp::PluginProgress *progress);
