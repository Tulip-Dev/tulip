...
public:
  PLUGININFORMATION("Align nodes", "Bruno Pinaud", "06/06/2023",
                    "Align a set of selected nodes on X or Y coordinates with an optional equal distance between the nodes", "1.0", "Misc")
