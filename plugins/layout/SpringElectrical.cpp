...
bool SpringElectrical::run() {
  ...
  inputSelection = superGraph->getProperty<Selection>("viewSelection");
  inputSize = superGraph->getProperty<Sizes>("viewSize");
  Layout *inputLayout = superGraph->getProperty<Layout>("viewLayout");
