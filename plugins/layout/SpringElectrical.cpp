...
//================================================================================
Coord attractiveForces(node n, LayoutProperty *layout, Graph * graph,   
...
bool SpringElectrical::run() {
  ...
  for (int count = 0; count < iterations; ++count) {
	...
	Coord att = maxForce( attractiveForces(itn, layoutResult, graph, sizeNorm, temperature, maxforce),  maxforce * temperature);
