...
public:
  PLUGININFORMATION("Cone Tree", "David Auber", "01/04/2001", "Implements an extension of the Cone tree layout algorithm first published as:<br/>"
...
private:
  double treePlace3D(tlp::node n, TLP_HASH_MAP<tlp::node, double> *posRelX, TLP_HASH_MAP<tlp::node, double> *posRelY);
  void calcLayout(tlp::node n, TLP_HASH_MAP<tlp::node, double> *px, TLP_HASH_MAP<tlp::node, double> *py, double x, double y, int level);
