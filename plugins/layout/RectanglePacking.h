...
public:
  RectangleRelativePositionList
      *firstSequence; /**< List which is useful for the stocking of the
                         first sequence of the even sequence. */

  int *placesOfRectanglesInSecondSequence; /**< Array which is used for the
                                              stocking of the positions of the
                                              rectangles in the second sequence.
                                            */

  int numberOfPositionnedRectangles; /**< Current value of the number of packed
                                        rectangles. */
  int numberOfRectangles; /**< Value of the number of rectangles to pack. */

  int bestPlaceInFirstSequence; /**< Current best position of a new rectangle to
                                   pack, in the first sequence, since the
                                   beginning of the position tests. */
  int bestPlaceInSecondSequence; /**< Current best position of a new rectangle
                                    to pack, in the second sequence, since the
                                    beginning of the position tests. */

  float newRectangleWidth;  /**< Width of a new rectangle to pack. */
  float newRectangleHeight; /**< Height of a new rectangle to pack. */

  float newRectangleLeftAbscissa; /**< Left abscissa of a new rectangle to pack,
                                     for a tested position. */
  float newRectangleLowOrdinate;  /**< Low ordinate of a new rectangle to pack,
                                     for a tested  position. */

  float bestRectangleLeftAbscissa; /**< Best left abscissa of a new rectangle to
                                      pack since the beginning of the position
                                      tests. */
  float bestRectangleLowOrdinate;  /**< Best low ordinate of a new rectangle to
                                      pack since the  beginning of the position
                                      tests. */

  float
      maxWidthOfBoundingBox;    /**< Width of the rectangle including all the
                                   packed rectangles and a    new rectangle to pack,
                                   for a tested position. */
  float maxHeightOfBoundingBox; /**< Width of the rectangle including all the
                                   packed rectangles and a new rectangle to
                                   pack, for a tested position. */

  float
      bestWidthOfBoundingBox; /**< Best width of the rectangle including all the
                                 packed rectangles and a new rectangle to pack
                                 since the beginning of the position tests. */
  float bestHeightOfBoundingBox; /**< Best height of the rectangle including all
                                    the packed rectangles and a new rectangle to
                                    pack since the beginning of the position
                                    tests. */
   ...
   */
  void defaultPositionRestOfRectangles(
      std::vector<tlp::Rectangle<float>>::iterator itlim,
   ...
   * the even sequence.
   */
  void optimalPositionOfNewRectangle(
  ...
  testOfPositionOfNewRectangle(int positionInFirstSequence,
   ...
   */
  std::list<RectangleRelativePosition>::iterator
  positionOfNewRectangle(int positionInFirstSequence,
                         int positionInSecondSequence);
   ...
   *or a column.
   */
  void endOfLine(float &heightTemp, float &widthTemp, bool &boolWidth,
                 bool &boolHeight);
   ...
   *or a column.
   */
  void endOfColumn(float &widthTemp, float &heightTemp, bool &boolWidth,
                   bool &boolHeight);
   ...
   */
  void continueLine(std::vector<tlp::Rectangle<float>>::iterator itr,
                    float &widthTemp, float &heightTemp, bool &boolWidth,
                    bool &boolHeight);
   ...
   */
  void continueColumn(std::vector<tlp::Rectangle<float>>::iterator itr,
                      float &widthTemp, float &heightTemp, bool &boolWidth,
                      bool &boolHeight);

  void optimalPositionOfNewRectangleLimPos(
      std::vector<tlp::Rectangle<float>>::iterator itNewRect,
