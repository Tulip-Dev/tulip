...
public:
  ...
  int bestPlaceInFirstSequence;  /**< Current best position of a new rectangle to pack, in the first sequence, since the beginning of the position
                                    tests. */
  int bestPlaceInSecondSequence; /**< Current best position of a new rectangle to pack, in the second sequence, since the beginning of the position
                                    tests. */
   ...
   *@param positionInSecondSequence position tested in the second sequence.
   */
  void coordinatesOfNewRectangle(std::list<RectangleRelativePosition>::iterator itRectLeftOrBelowOfNewRect, int positionInFirstSequence,
   ...
   *@param positionInSecondSequence position tested in the second sequence.
   */
  void repositionOfRectanglesRightOrAboveNewRectangle(std::list<RectangleRelativePosition>::iterator itFirstRectangleRightOrAboveOfNewRectangle,
  ...
  void modificationCoordinatesRectanglesRightOrAboveNewRectangleInFonctionNewRectangle(
      std::list<RectangleRelativePosition>::iterator itRectOfSequenceToReposition, int positionInSecondSequence);
  ...
  /**
    ...
    *right or above the new rectangle.
    */
  void modificationCoordinatesRectanglesRightOrAboveNewRectangleInFonctionAlreadyRepositionnedRectangles(
   ...
   */
  void modificationOfSequencePair(std::vector<tlp::Rectangle<float>>::iterator itNewRect,
