...
public:
  PLUGININFORMATION("Squarified Tree Map", "Tulip Team", "25/05/2010",
                    ...
                    "For Treemap see:<br/><b>Tree visualization with treemaps: a 2-d space-filling approach</b> , Shneiderman B., ACM Transactions "
                    "on Graphics, vol. 11, 1 pages 92-99 (1992).<br/>"
