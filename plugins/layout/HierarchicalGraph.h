...
public:
  PLUGININFORMATION("Hierarchical Graph", "David Auber", "23/05/2000",
                    ...
                    "<b>Tulip - A Huge Graph Visualization Framework</b>, D. Auber, Book. Graph Drawing Software. (Ed. Michael Junger & Petra "
                    "Mutzel) pages 105--126. (2004).",
                    "1.0", "Hierarchical")
...
private:
  ...
  void computeEdgeBends(const tlp::Graph *mySGraph, tlp::LayoutProperty &tmpLayout, const TLP_HASH_MAP<tlp::edge, tlp::edge> &replacedEdges,
