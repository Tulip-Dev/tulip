...
public:
  PLUGININFORMATION("MMM Example Nice Layout (OGDF)","Gereon Bartel","01/09/2010",
                    "Implement a nice multilevel graph layout using the OGDF modular multilevel-mixer. EdgeCoverMerger and BarycenterPlacer are used as merging and placement strategies.",
                    "1.0","Multilevel")
