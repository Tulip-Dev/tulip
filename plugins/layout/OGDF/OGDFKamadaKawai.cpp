...
static const char *paramHelp[] = {
    ...
    // zero length
    "If set != 0, value zerolength is used to determine the desirable edge length by L = zerolength / max distance_ij. Otherwise, zerolength is "
    "determined using the node number and sizes.",
...
public:
  PLUGININFORMATION("Kamada Kawai (OGDF)", "Karsten Klein", "12/11/2007", "Implements the Kamada-Kawai layout algorithm.<br/>It is a force-directed "
                                                                          "layout algorithm that tries to place vertices with a distance "
                                                                          "corresponding to their graph theoretic distance. ",
                    "1.0", "Force Directed")
