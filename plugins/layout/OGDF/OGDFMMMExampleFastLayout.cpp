 ...
 * and placement strategies. The FastMultipoleEmbedder is for force calculation.
 *
...
public:
  PLUGININFORMATION("MMM Example Fast Layout (OGDF)","Gereon Bartel","01/09/2010","Implement a fast multilevel graph layout using the OGDF modular multilevel-mixer. SolarMerger and SolarPlacer are used as merging and placement strategies.","1.0","Multilevel")
