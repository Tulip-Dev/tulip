...
public:
  PLUGININFORMATION("Pivot MDS (OGDF)", "Mark Ortmann", "29/05/2015", "By setting the number of pivots to infinity this algorithm behaves just like "
  ...
  OGDFPivotMDS(const tlp::PluginContext *context)
      : OGDFLayoutPluginBase(context, new ogdf::ComponentSplitterLayout()), pivotMds(new ogdf::PivotMDS()) {
