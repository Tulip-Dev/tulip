...
static const char *paramHelp[] = {
    ...
    // transpose
    "Determines whether the transpose step is performed after each 2-layer crossing minimization; this step tries to reduce the number of crossings "
    "by switching neighbored nodes on a layer.",
...
public:
  ...
  PLUGININFORMATION(
      ...
      "Implements the classical layout algorithm by Sugiyama, Tagawa, and Toda. It is a layer-based approach for producing upward drawings.", "1.6",
      "Hierarchical")
