...
public:
  ...
  PLUGININFORMATION("Fast Multipole Embedder (OGDF)","Martin Gronemann","12/11/2007","Implement the fast multipole embedder layout algorithm of Martin Gronemann.","1.0","Force Directed")
