...
#define ELT_EMBEDDER_LIST                                                                                                                            \
  "SimpleEmbedder;EmbedderMaxFace;EmbedderMaxFaceLayers;EmbedderMinDepth;EmbedderMinDepthMaxFace;EmbedderMinDepthMaxFaceLayers;EmbedderMinDepthPiTa" //;EmbedderOptimalFlexDraw"
...
static const char *embedderValuesDescription =
    ...
    "EmbedderMinDepthMaxFaceLayers <i>(Planar graph embedding with minimum block-nesting depth and maximum external face, plus layers "
    "approach)</i><br>"
...
static const char *paramHelp[] = {
    ...
    // Embedder
    "The result of the crossing minimization step is a planar graph, in which crossings are replaced by dummy nodes. The embedder then computes a "
    "planar embedding of this planar graph."};

class OGDFPlanarizationLayout : public OGDFLayoutPluginBase {

public:
  PLUGININFORMATION("Planarization Layout (OGDF)", "Carsten Gutwenger", "12/11/2007", "The planarization approach for drawing graphs.", "1.0",
                    "Planar")
