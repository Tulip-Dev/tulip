...
static const char *paramHelp[] = {
    ...
    // max iterations
    "This parameter allows to limit the number of iterations. The value of 0 "
    "corresponds to a default value of 100.",
    ...
    // nodes to skip
    "This boolean property is used to skip nodes in computation when their "
