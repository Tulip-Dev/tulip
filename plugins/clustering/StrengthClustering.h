...
public:
  PLUGININFORMATION("Strength Clustering", "David Auber", "27/01/2003",
                    "Implements a single-linkage clustering. The similarity measure used here is the Strength Metric computed on edges. The best "
                    "threshold is found using MQ Quality Measure. See :<br/>"
