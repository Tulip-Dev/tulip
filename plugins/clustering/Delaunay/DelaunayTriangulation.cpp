...
public :
  ...
  PLUGININFORMATION("Delaunay triangulation", "Antoine Lambert", "",
                    "Perform a Delaunay triangulation, in considering the positions of the graph nodes as a set of points. The building of simplices (triangles in 2D or tetrahedrons in 3D) consists in adding edges between adjacent nodes.","1.0","Triangulation")
