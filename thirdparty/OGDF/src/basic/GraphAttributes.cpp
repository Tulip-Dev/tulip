...
const char * GraphAttributes::edgeStyleToOGML(const GraphAttributes::EdgeStyle & edgeStyle) {
    switch (edgeStyle)  {
        case GraphAttributes::esNoPen:  return "esNoPen";
        case GraphAttributes::esSolid: return "esSolid";
        case GraphAttributes::esDash: return "esDash";
        case GraphAttributes::esDot: return "esDot";
        case GraphAttributes::esDashdot: return "esDashdot";
        case GraphAttributes::esDashdotdot: return "esDashdotdot";
        default: return "esSolid";
    }//switch
}
...
const char * GraphAttributes::imageAlignmentToOGML(const GraphAttributes::ImageAlignment &imgAlign){
    switch (imgAlign)   {
        case GraphAttributes::TopLeft:      return "topLeft";
        case GraphAttributes::TopCenter:    return "topCenter";
        case GraphAttributes::TopRight:     return "topRight";
        case GraphAttributes::CenterLeft:   return "centerLeft";
        case GraphAttributes::Center:       return "center";
        case GraphAttributes::CenterRight:  return "centerRight";
        case GraphAttributes::BottomLeft:   return "bottomLeft";
        case GraphAttributes::BottomCenter: return "bottomCenter";
        case GraphAttributes::BottomRight:  return "bottomRight";
...
const char * GraphAttributes::brushPatternToOGML(const GraphAttributes::BrushPattern & brushPattern) {
    switch (brushPattern) {
        case GraphAttributes::bpNone: return "bpNone";
        case GraphAttributes::bpSolid: return "bpSolid";
        case GraphAttributes::bpDense1: return "bpDense1";
        case GraphAttributes::bpDense2: return "bpDense2";
        case GraphAttributes::bpDense3: return "bpDense3";
        case GraphAttributes::bpDense4: return "bpDense4";
        case GraphAttributes::bpDense5: return "bpDense5";
        case GraphAttributes::bpDense6: return "bpDense6";
        case GraphAttributes::bpDense7: return "bpDense7";
        case GraphAttributes::bpHorizontal: return "bpHorizontal";
        case GraphAttributes::bpVertical: return "bpVertical";
        case GraphAttributes::bpCross: return "bpCross";
        case GraphAttributes::BackwardDiagonal: return "BackwardDiagonal";
        case GraphAttributes::ForwardDiagonal: return "ForwardDiagonal";
        case GraphAttributes::DiagonalCross: return "DiagonalCross";
        default: return "bpSolid";
    }//switch
}

void GraphAttributes::generateIndent(char ** indent, const int & indentSize) {
