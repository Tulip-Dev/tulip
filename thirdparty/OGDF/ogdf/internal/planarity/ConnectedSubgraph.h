...
public:
	 ...
	 * \param return SG is the connected subgraph containing nG.
	 * \param nG is a node in G.
	 * \param return nSG is the corresponding node of nG in SG.
	 * \param nodeLengthG is saving for each node of G its length.
	 * \param return nodeLengthSG is saving for each node of SG its length.
	 */
	 ...
	 * \param nodeLengthG is saving for each node of G its length.
	 * \param return nodeLengthSG is saving for each node of SG its length.
	 * \param return nG_to_nSG is a mapping of nodes in G to nodes in SG.
     */
	static void call(const Graph& G,
         Graph& SG,
         const node& nG,
	 ...
	 * \param return edgeLengthSG is saving for each edge of SG its length.
     */
	static void call(const Graph& G,
         Graph& SG,
         const node& nG,
