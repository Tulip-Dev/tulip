...
SET(CHAR_SEP ";")
IF(MSVC)
SET(ENV{PATH} "${BIN_DIR}/../../library/tulip-core/src/Debug;${BIN_DIR}/../../library/tulip-gui/src/Debug;${BIN_DIR}/../../library/tulip-ogl/src/Debug;${BIN_DIR}/../../library/tulip-ogdf/src/Debug;${BIN_DIR}/../../library/tulip-python/src/Debug;${BIN_DIR}/../../thirdparty/gzstream/Debug;${BIN_DIR}/../../thirdparty/quazip/Debug;${BIN_DIR}/../../thirdparty/ftgl/Debug;${BIN_DIR}/../../thirdparty/OGDF/Debug;${BIN_DIR}/../../thirdparty/yajl/src/Debug;${QT_BIN_DIR};$ENV{PATH}")
ELSE(MSVC)
SET(ENV{PATH} "${BIN_DIR}/../../library/tulip-core/src;${BIN_DIR}/../../library/tulip-gui/src;${BIN_DIR}/../../library/tulip-ogl/src;${BIN_DIR}/../../library/tulip-ogdf/src/;${BIN_DIR}/../../library/tulip-python/src/;${BIN_DIR}/../../thirdparty/gzstream;${BIN_DIR}/../../thirdparty/quazip;${BIN_DIR}/../../thirdparty/ftgl;${BIN_DIR}/../../thirdparty/OGDF;${BIN_DIR}/../../thirdparty/yajl/src;${QT_BIN_DIR};$ENV{PATH}")
ENDIF(MSVC)
ENDIF(WIN32)
IF(MSVC)
...
IF(NOT SYSTEM_SIP)
IF(MSVC)
SET(ENV{PYTHONPATH} "${BIN_DIR}/../../thirdparty/sip-${SIP_VERSION}/siplib/Debug${CHAR_SEP}$ENV{PYTHONPATH}")
ELSE(MSVC)
SET(ENV{PYTHONPATH} "${BIN_DIR}/../../thirdparty/sip-${SIP_VERSION}/siplib${CHAR_SEP}$ENV{PYTHONPATH}")
ENDIF(MSVC)
ENDIF()
IF(APPLE)
