 ...
 *
 * Create a graph
 * display all the structure using for
 *
 */
...
int main() {
  ...
  for(node n : graph->getNodes()) {
    ...
    cout << " predecessors: {";
    for(node in_node : graph->getInNodes(n)) {
    ...
    cout << " successors: {";
    for(node out_node : graph->getOutNodes(n)) {
      if (!first) {cout << ",";} else {first = false;}
      cout << out_node.id;
    }
    cout << "}" << endl;
    ...
    cout << " neighborhood: {";
    for(node in_out_node : graph->getInOutNodes(n)) {
      if (!first) {cout << ",";} else {first = false;}
      cout << in_out_node.id;
    }
    cout << "}" << endl;
    ...
    cout << " incoming edges: {";
    for(edge in_edge : graph->getInEdges(n)) {
      if (!first) {cout << ",";} else {first = false;}
      cout << in_edge.id;
    }
    cout << "}" << endl;
    ...
    for(edge out_edge : graph->getOutEdges(n)) {
      if (!first) {cout << ",";} else {first = false;}
      cout << out_edge.id;
    }
    cout << "}" << endl;
    ...
    cout << " adjacent edges: {";
    for(edge in_out_edge : graph->getInOutEdges(n)) {
      if (!first) {cout << ",";} else {first = false;}
      cout << in_out_edge.id;
    }
    cout << "}" << endl;
