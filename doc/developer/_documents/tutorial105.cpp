 ...
 * Tutorial 104
 *
 * Create 2 boxes and add a static 2D layer to display a circle in the foreground
 * export
...
int main(int argc, char **argv) {
  /*
  A QApplication must always be declared at the beginning of the main function in order for Tulip to
  work.
  ...
  */
  ...
  // We create the circle giving it's center position, it's color, it's radius and the number of
  // segments
