...
A subgraph is simply a coherent subset of the graph elements: some nodes of the graph, and some edges between them (more information: `Wikipedia: Subgraphs <https://en.wikipedia.org/wiki/Glossary_of_graph_theory#Subgraphs>`_).
